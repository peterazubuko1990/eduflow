...
<head><title>How to add Income Head? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Eduflow add income head"/>
    <meta name="description" content="How to add Income Head"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Income Head?</h3>
                                ...
                                <hr/>
                                <article class="article-body">To add income head go to <strong>Income &gt; Income
                                    head</strong>, here enter <strong>Income Head</strong> and
                                    <strong>Description</strong> then click on <strong>Save</strong> button, you can
                                    view this added record on the right side in the Income head list.<br/><br/><img
                                            src="../assets/article-media/income-add-incomehead.png"
                                            alt="Add income head image" width="1000" height="279"/><br/><br/>To edit
                                    income head click on the <strong>Edit</strong> icon present in the income head list
                                    and to delete the income head click on the <strong>Delete</strong> icon present in
                                    the income head list.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-income-head by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:33:24 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
