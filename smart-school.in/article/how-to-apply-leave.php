...
<head><title>How to Apply Leave? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Apply leave in Eduflow"/>
    <meta name="description" content="How to Apply Leave?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to Apply Leave?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Thu, 26 Nov, 2020</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Resource</a></div>
                                <hr/>
                                <article class="article-body">To apply leave, go to <strong>Human Resource &gt; Apply
                                    Leave</strong> then click on the <strong>Apply Leave</strong> button present at top
                                    right corner in leaves page, at click of this button <strong>Add Details</strong>
                                    modal will be open. Here select <strong>Apply Date, Available
                                        Leave,</strong>&nbsp;<strong>Leave Date, Reason </strong>and <strong>Attach
                                        Document</strong> and then click on <strong>Save</strong> button.<br/><br/><img
                                            src="../assets/article-media/humanresource-applyleave.png"
                                            alt="Apply leave image" width="1366" height="626"/><br/><br/>To view apply
                                    leave click on <strong>View</strong> icon present at <strong>Action</strong> column
                                    in the leaves page, at click of this icon <strong>Details</strong> modal will be
                                    open. Here you can see the details of staff member.<br/><br/><img
                                            src="../assets/article-media/humanresource-view-applyleavestaff-detail.png"
                                            alt="View apply leave detail image" width="1366" height="498"/><br/><br/>To
                                    delete apply leave click on <strong>Delete</strong> icon present at
                                    <strong>Action</strong> column in the leaves page.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-apply-leave by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:40:37 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
