...
<head><title>After adding staff or student no email is receiving? - Eduflow : School Management System by
    Eduflow</title>
    <meta charset="utf-8">
    ...
    <meta name="description" content="After adding staff or student no email is receiving"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">After adding staff or student no email
                                    is receiving?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Sun, 19 Apr, 2020</div>
                                </div>
                                ...
                                <hr/>
                                <article class="article-body">After <strong>adding staff or student if no email is
                                    receiving</strong> or <strong>there is no any email send by system</strong> then
                                    your email setting is not configured properly so system is unable to send any email.
                                    To configure email please check <a title="Email Send Not Working"
                                                                       href="email-send-not-working.php">this
                                        article</a>.
                                </article>
...
<!-- Mirrored from smart-school.in/article/after-adding-staff-or-student-no-email-is-receiving-1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:34:36 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
