...
<head><title>How student can view Transport Route list? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="student can view assigned vehicle in Eduflow"/>
    <meta name="description" content="How student can view Transport Route list?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How student can view Transport Route
                                    list?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Thu, 24 Dec, 2020</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a href="../category/transport.phpFF">Transport</a>
                                </div>
                                <hr/>
                                <article class="article-body">After login student panel, go to <strong>Transport
                                    Routes</strong>, here student can see all transport routes list. you can search any
                                    route by enter <strong>Route Title</strong>.<br/><br/><img
                                            src="../assets/article-media/transport-student-transportroutelist.png.png"
                                            alt="Transport route list image" width="1344" height="631"/><br/><br/>To
                                    view assigned vehicle, click on <strong>Click To View</strong> button present at
                                    <strong>Vehicle</strong> column in the transport routes page, at click of this
                                    button <strong>Vehicle Details</strong> modal will open. here student can see
                                    vehicle details like <strong>Vechicle No, Vehicle Model,&nbsp; Made, Driver Name,
                                        Driver Licence, Driver Contact.</strong><br/><br/><img
                                            src="../assets/article-media/transport-assighnvichledetails.png"
                                            alt="Vehicle details image" width="1350" height="625"/></article>
...
<!-- Mirrored from smart-school.in/article/how-student-can-view-transport-route-list by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:40:45 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
