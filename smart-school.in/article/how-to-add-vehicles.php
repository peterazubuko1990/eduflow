...
<head><title>How to add Vehicles? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="How to add Vehicles?"/>
    <meta name="description" content="How to add Vehicles?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Vehicles?</h3>
                                ...
                                <hr/>
                                <article class="article-body"><p>To add vehicles, go to <strong>Transport &gt;
                                    Vehicles. </strong>Vehicle list will be open.</p><img
                                        src="../assets/article-media/vehicle%20list%2000.png" alt="" width="790"
                                        height="390"/><br/><br/>
                                    <p>Here you can see the vehicle list, Now click on <strong>+Add</strong> button for
                                        add new vehicle, <strong>add vehicle </strong>model will be open, in this model
                                        you need to fill the all details of vehicle as <strong>Vehicle Number</strong>,
                                        <strong>Vehicle Model</strong>, <strong>Year Made</strong>, <strong>Registration
                                            Number</strong>, <strong>Chassis Number</strong>, <strong>Max Seating
                                            Capacity</strong>, <strong>Driver Name</strong>, <strong>Driver
                                            Licence</strong>, <strong>Driver Contact</strong>, <strong>Vehicle
                                            Photo</strong> and <strong>Note</strong> if any about the vehicle then click
                                        on <strong>Save</strong> button.<br/><br/><img
                                                src="../assets/article-media/add%20vehicles%201st%20ss.png" alt=""
                                                width="790" height="390"/><br/><br/></p>
                                    <p>You can see this added vehicle details in the <strong>Vehicle List</strong> and
                                        in <strong>action</strong> column you can see <strong>view</strong>, <strong>edit</strong>
                                        and <strong>delete</strong> option available, by click on <strong>view</strong>
                                        icon you can see the all vehicle details.<br/><br/><img
                                                src="../assets/article-media/view%20vehicle%204th%20ss.png" alt=""
                                                width="790" height="390"/><br/><br/></p>
                                    <p>To edit vehicle click on the <strong>Edit</strong> icon showing in vehicle list
                                        <strong>Action</strong> column edit model will be open, now you can update the
                                        vehicle details then click on <strong>save</strong> button, details will be
                                        update successfully.</p><img
                                            src="../assets/article-media/edit%20vehicles%203rd.png" alt="" width="790"
                                            height="390"/><br/><br/>
                                    <p>To <strong>delete</strong> the vehicle from the vehicle list, click on the
                                        <strong>Delete </strong>icon showing in the vehicle list <strong>Action</strong>
                                        column, <strong>confirmation</strong> model will be open then click on <strong>Ok</strong>
                                        button, vehicle will be deleted from the <strong>vehicle
                                            list</strong>.<br/><br/><img
                                                src="../assets/article-media/delete%20vehicle%205th%20ss.png" alt=""
                                                width="790" height="376"/></p></article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-vehicles by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:32:26 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
