...
<head><title>How can we check the student's behaviour report in his profile? - eduflow: School Management System by
    Eduflow</title>
    <meta charset="utf-8">
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How can we check the student's behaviour
                                    report in his profile?</h3>
                                ...
                                <hr/>
                                <article class="article-body"><p>To check the student behaviour report in his profile,
                                    go to <strong>Student Information &gt; Student Details.<br/><br/><img
                                            src="../assets/article-media/58%20student%20details.png" alt="" width="790"
                                            height="404"/><br/><br/></strong></p>
                                    <p>On the right side, the <strong>select criteria</strong> page will appear now,
                                        select the <strong>class</strong> and <strong>section</strong> of the student
                                        for whom you want to see a behaviour report, and click the
                                        <strong>search</strong> button.&nbsp;<br/><br/><img
                                                src="../assets/article-media/59%20Student%20list.png" alt="" width="790"
                                                height="410"/><br/><br/></p>
                                    <p>Now, click on the <strong>name of the student</strong> whose profile you want to
                                        view.&nbsp;<br/><br/><img
                                                src="../assets/article-media/60%20Student%20profiled.png" alt=""
                                                width="790" height="374"/><br/><br/></p>
                                    <p>Now click on <strong>student behaviour</strong> tab which is shown right
                                        above.<br/><br/><img
                                                src="../assets/article-media/61%20Student%20profile%20behaviour%20listy.png"
                                                alt="" width="790" height="368"/><br/><br/></p>
                                    <p>After clicking on <strong>student behaviour,</strong> you can see the behaviour
                                        report details for that particular student.</p>
                                    <p><br/><br/></p>
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="how-to-check-behaviour-records-in-reports.html">How to check behaviour
                                        records in reports?</a></li>
...
<!-- Mirrored from smart-school.in/article/how-can-we-check-the-students-behaviour-report-in-his-profile by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:39:21 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
