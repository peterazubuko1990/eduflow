...
<head><title>How to add Collect Fees? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add collect fees in Eduflow"/>
    <meta name="description" content="How to addCollect Fees?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Collect Fees?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Sat, 25 Feb, 2023</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a href="../category/fees-collection.php">Fees
                                    Collection</a></div>
                                <hr/>
                                <article class="article-body">To add collect fees, go to <strong>Fees Collection &gt;
                                    Collect Fees</strong> then select <strong>Class</strong> and
                                    <strong>Section</strong> and then click on <strong>Search</strong> button. You can
                                    also search by keyword in <strong>Search Text Box</strong> and click on
                                    <strong>Save</strong> button. The list of student will be shown in the below of the
                                    page.<br/><br/><img
                                            src="../assets/article-media/feescollection-view-collectfees.png"
                                            alt="View collect fees image" width="1363" height="612"/><br/><br/>To view
                                    fees detail click on <strong>Collect Fees</strong> button present at
                                    <strong>Action</strong> column in the student list, at click of this button <strong>Student
                                        Fees</strong> page will be open. Here you can see all assigned student fees
                                    details. To collect fees click on <strong>Add (+)</strong> icon present in action
                                    column, at click of this icon modal will be open. Fill all the details entries
                                    <strong>Date, Amount, Discount Group, Discount, Fine, Payment Mode</strong> (Cash,
                                    Cheque, DD, Bank Transfer, UPI, and Card) and <strong>Note</strong> (if you have any
                                    note) and then click on <strong>Collect Fees</strong> button.<br/><br/><img
                                            src="../assets/article-media/add%20ss.png" alt="" width="1366"
                                            height="643"/><br/>
                                    <p><br/>after click on<strong> collect fees</strong>, so that fees has been
                                        collected and you can see fees status as paid in status column.<br/><br/>Now to
                                        print fees receipt to click on<strong>&nbsp;Print</strong> button which is
                                        showing in <strong>Action</strong> column</p><img
                                            src="../assets/article-media/print%20ss.png" alt="" width="1366"
                                            height="651"/><br/><br/>clicking on it will open a <strong>fee
                                        receipt</strong><strong>.</strong><br/><br/><img
                                            src="../assets/article-media/fees%20note%20in%20the%20fee%20receipts.png"
                                            alt="" width="1366" height="497"/><br/><br/>In the receipt, you can see the
                                    all details related to fees as well as you can also see the one note that says,
                                    "<strong>This receipt is computer generated, hence no signature is required</strong><br/><br/>Now
                                    in<strong> Revert</strong> button visible for reverting this fees which is also
                                    showing in Action column.<br/><br/><img
                                            src="../assets/article-media/revert%20ss.png" alt="" width="1366"
                                            height="651"/><br/><br/>when you click on <strong>revert</strong> icon,
                                    revert confirmation model will be open.<br/><br/><img
                                            src="../assets/article-media/revert%20confirmation.png" alt="" width="1366"
                                            height="643"/><br/><br/>now click on <strong>Revert</strong> button, so that
                                    student fees will be reverted.<br/><br/>To collect multiple fees, at the same time
                                    select multiple fees from left check boxes then click on <strong>Collect
                                        Selected</strong> button, so that collect selected model will be open, in this
                                    model you can see the multiple fees and below pay button available, simply click on
                                    pay button, multiple fees will be collected.<br/><br/><img
                                            src="../assets/article-media/feescollection-collectfees.png"
                                            alt="Collect fees image" width="1356" height="663"/><br/><br/>To fees
                                    discount adjustment, click on <strong>Apply Discount</strong> button from Action
                                    column, at click of this button <strong>Discount</strong> modal will be open. Here
                                    enter <strong>Payment Id</strong> on which you want to apply discount and enter
                                    <strong>Description</strong> and then click on <strong>Apply Discount</strong>
                                    button.<br/><br/><img src="../assets/article-media/Feecollection-adujstment.png"
                                                          alt="Adjustment image" width="1366" height="601"/></article>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3">
                        <div class="ad_rsidebar">
                            <div class="sidebanners-ad"><a href="https://1.envato.market/smart_school_android_app"
                                                           target="_blank"><img
                                    src="../assets/front/ads/android-app.jpg" alt="Eduflow"></a></div>
                        </div>
                        <div class="sidecard">
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="how-to-fees-reminder.html">How to Fees Reminder?</a></li>
                                    <li><a href="how-to-check-fees-statement-report.html">How to check Fees Statement
                                        report?</a></li>
                                    <li><a href="how-to-check-balance-fees-report.html">How to check Balance Fees
                                        report?</a></li>
                                    <li><a href="how-to-check-fees-collection-report.html">How to check Fees Collection
                                        Report?</a></li>
                                    <li><a href="how-to-check-online-fees-collection-report.html">How to check Online
                                        Fees Collection Report?</a></li>
                                    <li><a href="how-to-check-payroll-report.html">How to check Payroll Report?</a></li>
                                    <li><a href="how-student-can-view-fees-details.php">How student can view fees
                                        Details?</a></li>
                                </ul>
...
<!-- Mirrored from smart-school.in/article/how-to-add-collect-fees by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:37:13 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
