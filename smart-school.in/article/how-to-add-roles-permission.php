...
<head><title>How to add Roles Permission? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add roles permission in Eduflow"/>
    <meta name="description" content="How to add Roles Permission?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Roles Permission?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Settings</a></div>
                                <hr/>
                                <article class="article-body">A user's role determines what they can and cannot do in a
                                    site. Each role has a default set of permissions. We can assign different permission
                                    to different user according to their roles.<br/><br/>To add roles, go to <strong>System
                                        Settings &gt; Roles Permission</strong> then enter role <strong>Name</strong>
                                    and then click on <strong>Save</strong> button. You can view this added record in
                                    the <strong>Role List</strong> on the right side of the page.<br/><br/><img
                                            src="../assets/article-media/test1.png" alt="" width="800"
                                            height="385"/><br/><br/>To delete role click on <strong>Delete</strong> icon
                                    present in the role list.<br/><br/>To assign permission click on <strong>Assign
                                        Permission</strong> icon present in role list, at click of this icon <strong>Assign
                                        Permission</strong> page will be open, Here you can assign permission for each
                                    module and then click on <strong>Save</strong> button.<br/><br/><img
                                            src="../assets/article-media/test2.png" alt="" width="800"
                                            height="385"/><br/><br/><img
                                            src="../assets/article-media/systemsetting-assign-rolepermission(2).png"
                                            alt="Assign role permission image-2" width="800" height="520"/></article>
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="how-to-add-print-header-footer.php">How to add Print Header Footer?</a>
                                    </li>
...
<!-- Mirrored from smart-school.in/article/how-to-add-roles-permission by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:35:16 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
