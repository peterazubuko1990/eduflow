<!doctype html>
<html lang="en">
<!-- Mirrored from smart-school.in/article/about-alumni by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:31:32 GMT -->
<!-- Added by HTTrack -->
<meta http-equiv="content-type" content="text/html;charset=UTF-8"/><!-- /Added by HTTrack -->
<head><title>About Alumni - eduflow: School Management System by eduflow</title>
    <meta charset="utf-8">
...
">
    <meta name="keywords" content="About Alumni"/>
    <meta name="description" content="About Alumni"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">About Alumni</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.html"><i class="fa fa-home"></i></a><a
                                        href="../articles.html">Articles</a><a href="../category/alumni.html">Alumni</a>
                                </div>
                                <hr/>
                                <article class="article-body">The <strong>Alumni</strong> module is for managing former
                                    students records like their current contact numbers, address and occupation etc. You
                                    can also create <strong>Events</strong> for alumni and send notifications to alumni.<br/><br/><strong>Alumni
                                        Module Workflow:</strong> In Alumni Module first we will add pass out students
                                    in alumni then we will create events for alumni.<br/><br/><br/><img
                                            src="../assets/article-media/54/alumni-module.png" alt="alumni module"
                                            width="1000" height="562"/></article>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3">
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    <li><a href="how-to-add-alumni.php">How to Add Alumni?</a></li>
...
<script src="../assets/admin/assets/js/support-eduflow
