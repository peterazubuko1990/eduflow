...
<head><title>How to add Route Pickup Point? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="add Route Pickup Point"/>
    <meta name="description" content="How to add Route Pickup Point"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Route Pickup Point?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Wed, 22 Feb, 2023</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a href="../category/transport.php">Transport</a>
                                </div>
                                <hr/>
                                <article class="article-body"><p>The <strong>route pickup point</strong> for a smart
                                    school refers to the specific stops along the transportation route where students
                                    are picked up and taken to the school. The exact <strong>pickup points</strong> are
                                    usually determined and communicated by the school, taking into consideration the
                                    convenience and safety of the students, as well as the efficiency of the
                                    transportation route. The pickup points may change from time to time based on the
                                    needs and circumstances of the school and students.<br/><br/></p>
                                    <p>To add a <strong>route pickup point</strong>, go to <strong>Transport &gt; Route
                                        Pickup Point. </strong>Here you can view the<strong>&nbsp;Route</strong>
                                        <strong>Pickup Point</strong>&nbsp;list. To add a new route pickup point, click
                                        on the <strong>+Add</strong> button that is showing in the top right corner. The
                                        add <strong>Route Pickup Point</strong> model will be open.<br/><br/><img
                                                src="../assets/article-media/Route%20pickup%20point%201st%20ss.png"
                                                alt="" width="790" height="390"/><br/><br/></p>
                                    <p>In this model, first you need to select the <strong>route</strong> for the
                                        student, or which route you will make shorter for the student. If in that route
                                        you want to make the <strong>multiple pickup point</strong>, just click on the
                                        <strong>Add More</strong> button that is showing in the right middle so that
                                        field will be open and you can set the multiple pickup point for that
                                        route.<br/><br/><img
                                                src="../assets/article-media/Route%20pickup%20point%202nd%20ss.png"
                                                alt="" width="790" height="390"/><br/><br/></p>
                                    <p>Now select the pickup point, which is where you will be picked up by the bus or
                                        other mode of transportation, and fill in the <strong>Distance</strong> from
                                        school to student destination pickup point, as well as the <strong>Pickup
                                            Time</strong> by using the <strong>time picker</strong>, and fill in the
                                        <strong>Monthly Fees</strong> that will be charged to the student on the route,
                                        before clicking the <strong>Save</strong> button. If you want to
                                        <strong>delete</strong> the pickup point for that route, simply click on the
                                        "<strong>Delete</strong>" (cross) icon next to the monthly fees, and when the
                                        <strong>delete confirmation</strong> message appears.<br/><br/><img
                                                src="../assets/article-media/Route%20pickup%20point%203rd%20ss.png"
                                                alt="" width="790" height="380"/><br/><br/></p>
                                    <p>Click on the "<strong>OK</strong>" button, and your <strong>pickup point</strong>
                                        for that route will be successfully deleted.&nbsp;<br/><br/></p>
                                    <p>After entering all of the details in the <strong>route pickup point</strong> and
                                        clicking the <strong>save</strong> button, your record will be successfully
                                        saved in the <strong>route pickup point list</strong>, where you can see the
                                        details of the <strong>route, pickup point, monthly fees, distance</strong>, and
                                        <strong>pickup time</strong> that you specified. You can now see the <strong>Reorder,
                                            Edit</strong>, and <strong>Delete</strong> icons in the
                                        <strong>action</strong> column.<br/><br/><img
                                                src="../assets/article-media/Route%20pickup%20point%204th%20ss.png"
                                                alt="" width="790" height="390"/><br/><br/></p>
                                    <p>With the help of <strong>Reorder</strong>, you can manage the order of <strong>pickup
                                        points</strong> on that <strong>route</strong>, just click on the <strong>Reorder
                                        icon</strong>, <strong>Order From School Location </strong>model will be open,
                                        now drag and drop the row or reset the pickup point with the help of the mouse
                                        so that you can manage the preferred order of <strong>pickup points</strong> on
                                        that <strong>route</strong>.<br/><br/><img
                                                src="../assets/article-media/Route%20pickup%20point%205th%20ss.png"
                                                alt="" width="790" height="379"/><br/><br/></p>
                                    <p>You can <strong>edit</strong> the <strong>route pickup point</strong> and its
                                        details, you just need to click on the <strong>Edit</strong>
                                        button.<br/><br/><img
                                                src="../assets/article-media/Route%20pickup%20point%206th%20ss.png"
                                                alt="" width="790" height="390"/><br/><br/></p>
                                    <p>If you want to <strong>delete</strong> a <strong>route pickup point</strong>,
                                        simply click on the <strong>Delete</strong> (<strong>cross</strong>) icon, a
                                        <strong>Confirmation</strong> model will appear, then click on the
                                        <strong>OK</strong> button.<br/><br/><img
                                                src="../assets/article-media/Route%20pickup%20point%207th%20ss.png"
                                                alt="" width="790" height="378"/><br/><br/>And your <strong>route pickup
                                            point</strong> will be successfully <strong>deleted</strong>.</p>
                                    <p><br/><br/><br/></p>
                                    <p><br/><br/><br/></p></article>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3">
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    <li><a href="about-transport.php">About Transport</a></li>
                                    <li><a href="how-to-check-transport-report.html">How to check Transport Report?</a>
                                    </li>
                                    <li><a href="how-student-can-view-transport-route-list.php">How student can view
                                        Transport Route list?</a></li>
                                    <li><a href="how-to-view-transport-routes-list.html">How to view Transport Routes
                                        list?</a></li>
                                    <li><a href="how-to-manage-transport-fees-master.html">How to manage transport fees
                                        master?</a></li>
                                </ul>
...
<!-- Mirrored from smart-school.in/article/how-to-add-route-pickup-point by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:40:51 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
