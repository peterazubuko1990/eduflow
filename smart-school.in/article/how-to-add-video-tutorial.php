...
<head><title>How to add video Tutorial? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="add video Tutorial"/>
    <meta name="description" content="How to add video Tutorial?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add video Tutorial?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Wed, 05 Apr, 2023</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a href="../category/download-center.php">Download
                                    Center</a></div>
                                <hr/>
                                <article class="article-body"><p>To add video link, go to <strong>Download Centre &gt;
                                    Video Tutorial</strong>. Video tutorial list will be open, in this list you can see
                                    the previous uploaded video link. Now to add a video link, click on the
                                    <strong>+Add</strong> button showing at top right corner.<br/><br/><img
                                            src="../assets/article-media/01%20video%20tutorial.png" alt="" width="1366"
                                            height="674"/><br/><br/></p>
                                    <p>Add Video Tutorial model will be open<strong>.</strong> Here select the <strong>Class</strong>,
                                        <strong>Section</strong>, enter <strong>Title </strong>of tutorial, <strong>Video</strong>
                                        <strong>Link (YouTube link)</strong> and <strong>Description </strong>about the
                                        tutorial, now click the <strong>Save</strong> button.&nbsp;<br/><br/><img
                                                src="../assets/article-media/03%20link%20add%20in%20video%20tutorial.png"
                                                alt="" width="1366" height="674"/><br/><br/>The video link will be show
                                        in <strong>Video Tutorial List, </strong>you can search that video link by
                                        <strong>class</strong>, <strong>section</strong> or <strong>search by</strong>
                                        <strong>title</strong>.&nbsp;<br/><br/><img
                                                src="../assets/article-media/04%20search%20video%20tutorial.png" alt=""
                                                width="1366" height="674"/><br/><br/></p>
                                    <p>If you want to <strong>view</strong>, <strong>edit</strong> and
                                        <strong>delete</strong> the video link, simply hovering the mouse over the video
                                        link view icon and click on this, video link with video will be
                                        open.<br/><br/><img
                                                src="../assets/article-media/05%20view%20edit%20delete%20button.png"
                                                alt="" width="1366" height="648"/><br/><br/></p>
                                    <p>For <strong>view</strong> option, simply click on view icon, video link will be
                                        open and you can view the details of the video tutorial, such as
                                        <strong>Class</strong>, <strong>Section</strong>, <strong>Title</strong>,
                                        <strong>Description</strong>, and <strong>Created</strong>
                                        <strong>By</strong>.<br/><br/><img
                                                src="../assets/article-media/06%20view%20option%20in%20video%20tutorial.png"
                                                alt="" width="1366" height="674"/><br/><br/></p>
                                    <p>For <strong>Edit Video Tutorial</strong>, simply click on edit icon, edit model
                                        will be open.<br/><br/><img
                                                src="../assets/article-media/07%20download%20video%20tutorial.png"
                                                alt="" width="1366" height="674"/><br/><br/></p>
                                    <p>Here, you can edit the <strong>Class</strong>, <strong>Section</strong>, <strong>Title</strong>,
                                        <strong>Video</strong> <strong>Link</strong> and <strong>Description</strong>,
                                        then click on the <strong>Save</strong> button, your video tutorial will be
                                        updated successfully.<br/><br/></p>
                                    <p>If you want to delete the video tutorial, simply click on the delete icon,
                                        <strong>Delete Confirm</strong> message will appear.<br/><br/><img
                                                src="../assets/article-media/08%20delete%20Video%20Tutorial.png" alt=""
                                                width="1366" height="660"/><br/><br/>Now click on ok button, video
                                        tutorial will be deleted successfully.</p></article>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3">
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    <li><a href="about-download-center.php">About Download Center</a></li>
                                    <li><a href="how-to-upload-content.html">How to Upload Content?</a></li>
                                    <li><a href="how-to-add-content-type.php">How to add content type?</a></li>
                                </ul>
...
<!-- Mirrored from smart-school.in/article/how-to-add-video-tutorial by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:33:10 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
