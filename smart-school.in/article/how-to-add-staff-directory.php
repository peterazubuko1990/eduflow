...
<head><title>How to add Staff Directory? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add staff directory in Eduflow"/>
    <meta name="description" content="How to add Staff Directory?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Staff Directory?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Sat, 12 Dec, 2020</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a href="../category/human-resource.php">Human
                                    Resource</a></div>
                                <hr/>
                                <article class="article-body">To add staff directory, go to <strong>Human Resource &gt;
                                    Staff Directory</strong> click on <strong>Add Staff</strong> button present at top
                                    right corner in the page, at click of this button <strong>Basic Information</strong>
                                    page will be open.<br/><br/>Fill all entries here <strong>Staff ID, Role,
                                        Designation, Department, First Name, Last Name, Father Name, Mother Name,
                                        Email</strong> (Login Username), <strong>Gender, Date of Birth, Date of Joining,
                                        Phone, Emergency Contact Number, Marital Status, Photo, Current Address,
                                        Permanent Address, Qualification, Work Experience, Note, PAN
                                        Number. </strong><br/><br/>If you want to add more details of the Staff, then
                                    click on <strong>+</strong> icon. Here you fill all the details <strong>Payroll
                                        &ndash; EPF No</strong> (Employee provident Fund Number)<strong>, Basic Salary,
                                        Contract Type, Work Shift, Location, Leaves &ndash; Medical Leave,</strong>
                                    <strong>Casual Leave, Maternity Leave, Bank Account Details &ndash; Account Title,
                                        Bank Account Number,</strong> <strong>Bank Name, IFSC Code, Bank Branch Number,
                                        Social Media Link &ndash; Facebook URL, Twitter URL, Linkedin URL, Instagram
                                        URL, Upload Documents &ndash; Resume, Joining Letter</strong> and <strong>Other
                                        Documents</strong> and then click on <strong>Save</strong> button. You can view
                                    this added record of staff in the staff list page.<br/><br/><img
                                            src="../assets/article-media/humanresource-add-staffdirectory.png"
                                            alt="Add staff directory image" width="1360" height="1755"/><br/><br/>Here
                                    select <strong>Role</strong> and then click on <strong>Search</strong> button, the
                                    list of staff will be shown in the below of the page. You can see staff list in card
                                    view and list view by clicking <strong>Card View</strong> and <strong>List
                                        View</strong> tab.<br/><br/><img
                                            src="../assets/article-media/humanresource-staffdirectory.png"
                                            alt="staff directory image" width="1366" height="494"/><br/><br/>To view
                                    staff details click on <strong>Show</strong> icon present in staff card. Here you
                                    can view basic details of staff Like <strong>Profile, Payroll, Leaves, Attendance,
                                        Documents</strong> and <strong>Timeline</strong>.<br/><br/><img
                                            src="../assets/article-media/humanresource-staffprofile.png"
                                            alt="Staff profile image" width="1364" height="1063"/></article>
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="how-to-view-disabled-staff.html">How to view Disabled Staff?</a></li>
                                    <li><a href="how-to-check-staff-attendance-report.html">How to check Staff
                                        Attendance Report?</a></li>
                                    <li><a href="how-to-check-payroll-report-1.html">How to check Payroll Report?</a>
                                    </li>
                                    <li><a href="how-student-can-check-teacher-review.php">How student can check teacher
                                        review?</a></li>
                                </ul>
...
<!-- Mirrored from smart-school.in/article/how-to-add-staff-directory by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:32:00 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
