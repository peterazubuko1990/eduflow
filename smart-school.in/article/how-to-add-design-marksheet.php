...
<head><title>How to add Design Marksheet? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Design marksheet in Eduflow"/>
    <meta name="description" content="How to add Design Marksheet?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Design Marksheet?</h3>
                                ...
                                <hr/>
                                <article class="article-body">To add design marksheet, go to<strong> Examination &gt;
                                    Design MarkSheet </strong>then enter <strong>Template, Heading, Title, Exam Name,
                                    School Name, Exam centre, Body Text, Footer Text, Printing Date, Left Logo, Right
                                    Logo, Left Sign, Middle Sign, Right Sign</strong> and <strong>Background
                                    Image</strong> and then <strong>Enable/Disable</strong> Fields on marksheet and then
                                    click on <strong>Save</strong> button. You can view this added record in the
                                    <strong>Marksheet List</strong> on the right side of the page.<br/><br/><img
                                            src="../assets/article-media/examination-add-designmarksheet.png"
                                            alt="Add design mark sheet image" width="1348" height="666"/><br/><br/><br/>To
                                    view marksheet click on the <strong>View</strong> icon present at
                                    <strong>Action</strong> column in the marksheet list, at click of this icon<strong>
                                        View Marksheet</strong> model will be open.<br/><br/><img
                                            src="../assets/article-media/Examination-view-marksheet.png"
                                            alt="View marksheet" width="1358" height="1259"/><br/><br/>To edit marksheet
                                    click on <strong>Edit</strong> icon and to delete marksheet click on the<strong>
                                        Delete</strong> icon present in the marksheet list.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-design-marksheet by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:37:30 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
