...
<head><title>How to add student ID card? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="add student id card, view id card in Eduflow"/>
    <meta name="description" content="How to add student ID card?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add student ID card?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Sat, 02 Dec, 2023</div>
                                </div>
                                ...
                                <hr/>
                                <article class="article-body">To add student ID card, go to <strong>Certificate &gt;
                                    Student ID Card</strong> then fill all entries <strong>Background Image, Logo,
                                    Signature </strong>(principal or authorized person signature image)<strong>, School
                                    Name, Address/ Phone/Email, ID Card Title, Header Color, Admission Number, Student
                                    Name, Class, Father Name, Mother Name, Student Address, Phone (student Phone), Date
                                    Of Birth and Blood Group</strong>&nbsp; and then click on <strong>Save</strong>
                                    button. You can view this added record in the <strong>Student ID Card List</strong>
                                    on the right side of the page.<br/><br/><img
                                            src="../assets/article-media/student%20id%20card.png" alt="" width="1330"
                                            height="824"/><br/><br/><br/>To view ID card click on <strong>View</strong>
                                    icon present at action column in the student ID card List page, at click of this
                                    icon ID card will be open.<br/><br/><img
                                            src="../assets/article-media/certificate-view-idcard.png"
                                            alt="view id card image" width="1358" height="524"/><br/><br/>To edit ID
                                    card click on <strong>Edit</strong> icon and to delete ID card click on <strong>Delete</strong>
                                    icon present in the student ID card list.<br/><br/><strong>Note:</strong> In ID card
                                    design we will suggest you to try to edit ID card design parameters by edit as many
                                    time possible until you will get your perfect design. You have to adjust many time
                                    design parameters to get your perfect design. While adjusting design parameters take
                                    browser final print preview or print as pdf option from browser as final reference
                                    of print design from <strong>Generate ID Card</strong> link. Otherwise in final
                                    print you will get little bit deviation in design. All ID card designs can be see
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="how-to-add-student-certificate.php">How to add student Certificate?</a>
                                    </li>
...
<!-- Mirrored from smart-school.in/article/how-to-add-student-id-card by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:32:12 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
