...
<head><title>How can a guest user buy a course? - eduflow: School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="guest user buy a course"/>
    <meta name="description" content="How can a guest user buy a course?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How can a guest user buy a course?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Course</a></div>
                                <hr/>
                                <article class="article-body"><p>The course is available for purchase by guests. Other
                                    users can also buy the online course. To purchase the <strong>online course</strong>,
                                    go to the <strong>online course</strong> and add it to your card of choice. Before
                                    logging in, click on the "<strong>cart</strong>" icon at the top right side of the
                                    screen.<br/><br/><img src="../assets/article-media/01%20online%20courses.png" alt=""
                                                          width="1366" height="789"/><br/><br/><br/></p>
                                    <p>When you click on it, a pop-up window appears, here you can view the "<strong>delete</strong>"
                                        option. You can delete items from the cart here, and you can view them by
                                        <strong>Go To Cart</strong> option and clicking on them.</p>
                                    <p>If you don&rsquo;t delete the items and click on the "go to cart"
                                        option.<br/><br/><img
                                                src="../assets/article-media/02%20go%20to%20cart%20option.png" alt=""
                                                width="1366" height="681"/><br/><br/></p>
                                    <p>Here you can <strong>delete</strong> the courses that were added to your cart.
                                    </p>
                                    <p>You can see the <strong>Continue Shopping</strong> option here, click on it if
                                        you want to add more items or continue shopping.&nbsp;<br/><br/><img
                                                src="../assets/article-media/03%20proceed%20to%20checkout.png" alt=""
                                                width="1366" height="681"/><br/><br/></p>
                                    <p>Here you can view <strong>proceed to checkout option</strong>. When you click on
                                        it, you can see <strong>Login </strong>pop-up window.<br/><br/><img
                                                src="../assets/article-media/04%20guest%20login.png" alt="" width="1366"
                                                height="681"/><br/><br/>Here if visitors don&rsquo;t have login details,
                                        they can <strong>sign up</strong> by entering their <strong>name</strong>,
                                        <strong>email</strong> <strong>address</strong>, and <strong>password</strong>,
                                        then clicking <strong>sign up.<br/><br/><img
                                                src="../assets/article-media/05%20guest%20registrations.png" alt=""
                                                width="1366" height="681"/><br/><br/></strong></p>
                                    <p>Now click on <strong>Proceed</strong> <strong>To checkout</strong>, click
                                        <strong>Pay with card</strong>.<br/><br/><img
                                                src="../assets/article-media/gateway.png" alt="" width="1366"
                                                height="643"/><br/><br/></p>
                                    <p>Enter your <strong>email address</strong>, <strong>card number</strong>, <strong>MM/YY,</strong>
                                        and <strong>CVC</strong>, and finally click the "<strong>Pay</strong>" button.
                                        To follow this procedure, a guest user can purchase course materials.</p>
                                </article>
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="how-to-add-course.php">How to add Course?</a></li>
...
<!-- Mirrored from smart-school.in/article/how-can-a-guest-user-buy-a-course by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:38:32 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
