...
<head><title>How to add Visitor Book? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add visitor book in Eduflow"/>
    <meta name="description" content="How to add Visitor Book?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Visitor Book?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Fri, 24 Feb, 2023</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a href="../category/front-office.php">Front
                                    Office</a></div>
                                <hr/>
                                <article class="article-body"><p>To add visitor book, go to <strong>Front
                                    Office</strong> <strong>&gt; Visitor Book.<br/><br/><img
                                        src="../assets/article-media/01%20visitor%20book.png" alt="" width="1366"
                                        height="681"/><br/><br/></strong>then click on <strong>Add</strong> button, add
                                    visitor model will be open.<br/><br/><img
                                            src="../assets/article-media/new%2002%20add%20visitor%20book.png" alt=""
                                            width="1366" height="681"/><br/><br/></p>
                                    <p>Here <strong>Add Visitor,</strong> select the <strong>Purpose</strong>, <strong>Meeting
                                        With </strong>(in meeting with, when you select the student, three new fields
                                        will be appear in add visitor model which are class, section and
                                        student).<br/><br/><img
                                                src="../assets/article-media/02%20add%20visitor%20books.png" alt=""
                                                width="1366" height="681"/><br/><br/><br/>And when you select the staff,
                                        staff tab will be appear in the model.<br/><br/><img
                                                src="../assets/article-media/03%20add%20visitor%20staffs.png" alt=""
                                                width="1366" height="681"/><br/><br/></p>
                                    <p>And now further fill the details as <strong>Visitor Name</strong>,
                                        <strong>Phone</strong>, <strong>ID Card</strong>, <strong>Number Of
                                            Person</strong>, <strong>Date</strong>, <strong>In Time, Out Time</strong>,
                                        <strong>Attach Document</strong> and <strong>Note</strong> and then click on the
                                        <strong>Save</strong> button. You can view this added record in front page of
                                        visitor book.<br/><br/>To view visitor click on <strong>View</strong> icon
                                        present at <strong>Action</strong> column in the visitor list, at click of this
                                        icon <strong>Details</strong> modal will be open. Here you can see the details
                                        of the visitor.<br/><br/><img
                                                src="../assets/article-media/04%20visitor%20detailss.png" alt=""
                                                width="1366" height="681"/><br/><br/></p>
                                    <p>To download click on <strong>Download</strong> icon document will be download and
                                        to edit visitor details, simply just click on <strong>Edit</strong> icon, edit
                                        model will be open.<br/><br/><img
                                                src="../assets/article-media/05%20edit%20visitor%20books.png" alt=""
                                                width="1366" height="681"/><br/><br/>Now update the visitior details and
                                        click on the save button, your update will be <strong>Save</strong>
                                        successfully.<br/><br/>To delete visitor click on <strong>Delete</strong> icon
                                        present in the visitor list, Confirmation model will be open.<br/><br/><img
                                                src="../assets/article-media/06%20delete%20visitor%20books.png" alt=""
                                                width="1366" height="603"/><br/><br/>Click on <strong>OK</strong>
                                        button, visitor details will be deleted successfully.</p>
                                    <p><br/><br/></p><br/><br/><br/><br/><br/></article>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3">
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    <li><a href="about-front-office.php">About Front Office</a></li>
...
<!-- Mirrored from smart-school.in/article/how-to-add-visitor-book by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:31:49 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
