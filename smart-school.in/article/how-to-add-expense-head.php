...
<head><title>How to add Expense Head? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Eduflow add expense head"/>
    <meta name="description" content="How to add Expense Head?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Expense Head?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        ...
                                        href="../category/expenses.php">Expenses</a></div>
                                <hr/>
                                <article class="article-body">To add expense head, go to <strong>Expense &gt; Expense
                                    Head</strong>, here enter <strong>Expense Head</strong> and
                                    <strong>Description</strong> and then click on <strong>Save</strong> button, you can
                                    view this added record on the right side in the Expense head list.<br/><br/><img
                                            src="../assets/article-media/expense-add-expensehead.png.png"
                                            alt="Add expense head image" width="1000" height="307"/><br/><br/>To edit
                                    expense head, click on the <strong>Edit</strong> icon present in the expense head
                                    list and to delete the expense head click on the <strong>Delete</strong> icon
                                    present in the expense head list.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-expense-head by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:33:20 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
