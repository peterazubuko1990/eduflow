...
<head><title>How to add menus? - eduflow: School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add menus in Eduflow"/>
    <meta name="description" content="How to add menus?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add menus?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a href="../category/front-cms.php">Front
                                    CMS</a></div>
                                <hr/>
                                <article class="article-body">To add menu, go to <strong>Front CMS &gt; Menus</strong>,
                                    here by default two menus are given (Main menu, Bottom Menu) then enter
                                    <strong>Menu</strong> and <strong>Description</strong> and then click on <strong>Save</strong>
                                    button. You can view this added record in the<strong> Menu List</strong> on the
                                    right of the page.<br/><br/><img src="../assets/article-media/frontcms-add-menu.png"
                                                                     alt="Add menu image" width="1343"
                                                                     height="523"/><br/><br/>To delete menu click on
                                    <strong>Delete</strong> icon present at <strong>Action</strong> column in the menu
                                    list.<br/><br/>To add menu item click on <strong>Add (+)</strong> icon present at
                                    <strong>Action</strong> column in the menu list, at click of this icon <strong>Add
                                        Menu Item</strong> page will be open. <br/><br/><img
                                            src="../assets/article-media/frontcms-add-menuitem1.png"
                                            alt="Add menu item image" width="1366" height="528"/><br/><br/>Here enter
                                    <strong>Menu Item, External URL, Open In New Tab, External URL Address,
                                        Pages</strong> and then click on <strong>Save</strong> button. You can view this
                                    added record in the <strong>Menu Item List</strong> on the right side of the page.
                                    Here you can arrange menu order and add menu item up and down in menu item
                                    list.<br/><br/><img src="../assets/article-media/frontcms-add-menuitem.png"
                                                        alt="Add menu item image" width="1358" height="890"/><br/><br/>To
                                    edit menu item click on <strong>Edit</strong> icon and to delete menu item click on
                                    <strong>Delete</strong> icon present in the menu item list.
                                </article>
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="how-to-add-banner-images.php">How to add Banner Images?</a></li>
                                </ul>
...
<!-- Mirrored from smart-school.in/article/how-to-add-menus by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:29:59 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
