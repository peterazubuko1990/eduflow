...
<head><title>How to add contact in chat? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="add contact, chat in Eduflow"/>
    <meta name="description" content="How to add contact in chat?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add contact in chat?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a href="../category/miscellaneous.php">Miscellaneous</a>
                                </div>
                                <hr/>
                                <article class="article-body">To add contact in chat, Superadmin/ Admin user need to
                                    login in Eduflow, then click on <strong>Chat</strong> icon present at top right
                                    corner in the header, at click of this icon add chat page will be
                                    open.<br/><br/><img src="../assets/article-media/chat-chatsytem.png"
                                                        alt="Chat system image" width="1366" height="633"/><br/><br/>Now
                                    click on <strong>+</strong> icon present in the chat system page, at click of this
                                    icon <strong>Add Contact</strong> modal will be open. Here search the student whom
                                    you want to add and then click on <strong>Add</strong> button. You can view this
                                    added student on the chat system page.<br/><br/><img
                                            src="../assets/article-media/chat-add-contact.png" alt="Add contact image"
                                            width="1358" height="660"/><br/><br/>Now to start chat click on the <strong>member
                                        name</strong> (staff, student) from chat system, at click of the name a <strong>member's
                                        chat window</strong> will open, here enter the message and click to Send button.
                                    You can also check new messages in the chat system.<br/><br/><img
                                            src="../assets/article-media/chat-window.png" alt="Chat window image"
                                            width="1350" height="636"/></article>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3">
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    <li><a href="about-chat.php">About Chat</a></li>
                                </ul>
...
<!-- Mirrored from smart-school.in/article/how-to-add-contact-in-chat by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:28:14 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
