...
<head><title>How to add the exam in CBSE Examination? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add the exam in CBSE
                                    Examination?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Examination</a></div>
                                <hr/>
                                <article class="article-body"><p>To add exam, go to the <strong>CBSE Examination &gt;
                                    Exam</strong>. After clicking Exam, <strong>Exam List</strong> will be open on the
                                    right side.<br/><br/><img src="../assets/article-media/01s.png" alt="" width="1366"
                                                              height="734"/><br/><br/></p>
                                    <p>Now on the top right corner, you can see the <strong>Add</strong> button, simply
                                        click on <strong>Add</strong> button, Add Exam model will be open.<br/><br/><img
                                                src="../assets/article-media/02s.png" alt="" width="1366" height="734"/>
                                    </p>
                                    <p>In this model, first, you need to enter the <strong>Exam Name</strong>. To
                                        publish the exam, check the checkboxes (For a recommendation, fill in all the
                                        details related to the exam first, then publish the exam. After completing the
                                        exam, you can also publish the result by checking the checkbox for publishing
                                        the result). Now provide a <strong>Description</strong> of the exam. Next,
                                        select the <strong>Term</strong> field that you have already created in the
                                        <strong>CBSE Examination &gt; Term</strong> module. Click on the term field
                                        dropdown list to open it, and select the term you wish to use for this exam for
                                        the relevant <strong>Class</strong> and <strong>Section</strong> you have
                                        chosen. Finally, select the <strong>Assessment</strong> that you have already
                                        added in the <strong>Assessment</strong> module, and choose the preferred
                                        <strong>Grade</strong> for that exam. Then click on the <strong>save</strong>
                                        button, and the new exam will be added to the exam list.<br/><br/><img
                                                src="../assets/article-media/03s.png" alt="" width="1366" height="734"/><br/><br/>
                                    </p>
                                    <p>To edit the exam, simply click on the <strong>edit</strong> (pencil) icon showing
                                        at the action column, <strong>Edit Exam</strong> model will be
                                        open.<br/><br/><img src="../assets/article-media/fd33.png" alt="" width="1440"
                                                            height="775"/><br/><br/></p>
                                    <p>Please update the exam details as desired, then click on the
                                        <strong>save</strong> button. Your details will be successfully updated and can
                                        be viewed in the exam list.<br/><br/><img src="../assets/article-media/05s.png"
                                                                                  alt="" width="1366"
                                                                                  height="734"/><br/><br/><strong>Note:-</strong>
                                        1. Once you have created the exam and added the subjects along with all the
                                        related details, you can proceed to <strong>publish</strong> the exam by
                                        utilizing the edit icon. Simply click on the <strong>edit</strong> icon, which
                                        will open the edit exam model. Within this mode, you can check the <strong>Publish</strong>
                                        Exam checkbox. By checking this checkbox and click on <strong>save</strong>
                                        button,&nbsp; your exam will be successfully published, and it will become
                                        visible in the exam schedule for both superadmin and students.<br/><br/>2. For
                                        <strong>Publish Result</strong>, you can proceed to publish the results by
                                        utilizing the edit icon. Simply click on the <strong>edit</strong> icon, which
                                        will open the edit model. Within this model, you can check the <strong>Publish
                                            Result</strong> checkbox. By checking this checkbox and click on <strong>save</strong>
                                        button, your results will be successfully published, and it will become visible
                                        in the <strong>Exam Results</strong> section from students side. On the
                                        superadmin side, you can access the results in the reports module or download
                                        the marksheet from the print marksheet module.</p></article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-the-exam-in-cbse-examination by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:35:46 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
