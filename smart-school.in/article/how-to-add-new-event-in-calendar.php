...
<head><title>How to add new event in calendar? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="add new event, calendar, event in Eduflow"/>
    <meta name="description" content="How to add new event in calendar?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add new event in calendar?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Mon, 04 Sep, 2023</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.html"><i class="fa fa-home"></i></a><a
                                        href="../articles.html">Articles</a><a href="../category/miscellaneous.html">Miscellaneous</a>
                                </div>
                                <hr/>
                                <article class="article-body">To add event in calendar, Superadmin /Admin user need to
                                    login in Eduflow, then click on <strong>Calendar</strong> icon present at top
                                    right corner in the header, this will redirect you in the calendar page, then click
                                    on the date you want to add the event, <strong>Add New Event</strong> model will be
                                    open, now enter <strong>Event Title, Description, Event Date, Event Color</strong>
                                    and select <strong>Event Type</strong> (Public is visible to all,
                                    <strong>Private</strong> is only you can see this event, <strong>All &lt;your role&gt;</strong>
                                    is this event will be visible to all users of your role, <strong>Protected</strong>
                                    that means it is visible to all staff members but not student or parent) and then
                                    click on <strong>Save</strong> button.<br/><br/>While adding a new event on any
                                    particular date using the calendar module, an email will be sent to the staff member
                                    and the student at their registered email addresses. However, this email will not be
                                    sent to the guardian<br/><br/><img
                                            src="../assets/article-media/calendar-add-event.png" alt="Add event image "
                                            width="1365" height="661"/><br/><br/><img
                                            src="../assets/article-media/calendar-event.png" alt="Event image"
                                            width="1366" height="606"/></article>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3">
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    <li><a href="about-calendar.php">About Calendar</a></li>
...
<!-- Mirrored from smart-school.in/article/how-to-add-new-event-in-calendar by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:28:12 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
