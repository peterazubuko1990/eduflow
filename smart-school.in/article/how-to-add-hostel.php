...
<head><title>How to Add Hostel? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Eduflow add hostel"/>
    <meta name="description" content="How to Add Hostel?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to Add Hostel?</h3>
                                ...
                                <hr/>
                                <article class="article-body">To add hostel, go to<strong> Hostel &gt; Hostel</strong>.
                                    Here enter the <strong>Hostel Name,</strong> select the <strong>Hostel Type</strong>
                                    and enter <strong>Address, Intake</strong> and <strong>Description</strong> and then
                                    click on <strong>Save</strong> button. You can view this added record in the
                                    <strong>Hostel List</strong> present on the right side of the page. <br/><br/><img
                                            src="../assets/article-media/hostel-add-hostel.png" alt="Add hostel image"
                                            width="1362" height="563"/><br/><br/>To edit hostel click on the<strong>
                                        Edit</strong> icon present in the hostel list and to delete the hostel click on
                                    the <strong>Delete</strong> icon present in the hostel list.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-hostel by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:32:17 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
