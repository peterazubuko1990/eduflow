...
<head><title>How to add question on particular exam? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="add question on particular exam in Eduflow"/>
    <meta name="description" content="How to add question on particular exam?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add question on particular
                                    exam?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Mon, 05 Apr, 2021</div>
                                </div>
                                ...
                                <hr/>
                                <article class="article-body">To add question on particular exam, go to <strong>Online
                                    Examinations &gt; Online Exam</strong> then click on <strong>Question</strong> icon
                                    present at <strong>Action</strong> column in the exam list, at click of this icon
                                    <strong>Select Question</strong> modal will be open.<br/><br/><img
                                            src="../assets/article-media/onlineex-addquestion-icon.png"
                                            alt="add question icon" width="1919" height="644"/><br/><br/>Now select
                                    <strong>Subject, Class, Section</strong> and then click on <strong>Search</strong>
                                    button. After searching, all the questions related to that subject will be visible
                                    to you, then select the question you want to add in exam.<br/><br/><img
                                            src="../assets/article-media/onlineex-selectquestion.png"
                                            alt="assign question to online exam image" width="1350"
                                            height="644"/><br/><br/>To view question list of perticular exam, click on
                                    the <strong>File-Text</strong> icon, this will show you all the question list
                                    related to the exam.<br/><br/><img
                                            src="../assets/article-media/onlineex-view-queslist.png" alt="" width="1920"
                                            height="642"/><br/><br/><br/><img
                                            src="../assets/article-media/onlineex-queslist-modal.png"
                                            alt="Question List" width="1909" height="841"/><br/><br/><br/><strong><span
                                            style="color: #e74c3c;">Note</span>&nbsp;-&nbsp;</strong>If&nbsp;<strong>Show
                                        me only my question</strong>&nbsp;option is&nbsp;<strong>Enabled</strong>&nbsp;and&nbsp;<strong>Teacher
                                        Restricted Mode</strong>&nbsp;is&nbsp;<strong>Disabled</strong>&nbsp;then
                                    teacher can view only those questions list which is added by him/her and
                                    if&nbsp;<strong>Teacher Restricted
                                        Mode</strong>&nbsp;is&nbsp;<strong>Enabled&nbsp;</strong>and&nbsp;<strong>Show
                                        me only my question&nbsp;</strong>option
                                    is&nbsp;<strong>Enabled/Disabled</strong>&nbsp;then teacher can only add/see
                                    questions list of that class in which he/she is a class teacher or subject teacher.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-question-on-particular-exam by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:29:55 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
