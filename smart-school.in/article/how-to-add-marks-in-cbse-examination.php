...
<head><title>How to add marks in CBSE Examination? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add marks in CBSE
                                    Examination?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Examination</a></div>
                                <hr/>
                                <article class="article-body"><p>To add the marks, go to the <strong>CBSE Examination
                                    &gt; Exam</strong>. Exam list will be open on the right side, now in action column,
                                    you can see the <strong>Exam Marks</strong> icon which is showing in beside of exam
                                    subjects.<br/><br/><img src="../assets/article-media/01K.png" alt="" width="1366"
                                                            height="734"/></p>
                                    <p>Simply click on the <strong>Exam Marks</strong> icon, <strong>Exam
                                        Subject </strong>model will be open.<br/><br/><img
                                            src="../assets/article-media/02k.png" alt="" width="1366" height="734"/></p>
                                    <p>On this model, you can view the details of the <strong>Exam, Class,
                                        Section</strong>, and all the subjects with their respective <strong>Dates,
                                        Times</strong>, and <strong>Room</strong> numbers that you previously added
                                        through the <strong>Add Exam Subject </strong>feature. Additionally, you can now
                                        see the <strong>Enter Marks</strong> column where you can add marks
                                        subject-wise. To do so, simply click on the icon corresponding to the subject
                                        for which you want to enter marks. For example, if you click on the first icon
                                        for the Hindi subject, the<strong> Enter Hindi Marks </strong>model will appear.<br/><img
                                                src="../assets/article-media/03k.png" alt="" width="1366" height="734"/>
                                    </p>
                                    <p>In this model, you can view multiple students for a particular subject along with
                                        their <strong>Admission Number, Roll Number, Father's Name, </strong>and<strong>
                                            Gender</strong>. You can also see the <strong>Theory</strong> and <strong>Practical</strong>
                                        columns with corresponding input fields. Simply enter the marks based on the
                                        students' performance along with any notes you want to include regarding their
                                        performance. If a student was absent during the relevant exam, simply check the
                                        <strong>Mark As Absent</strong> checkbox located above the input field and
                                        finally click on the <strong>save</strong> button and marks will be save for
                                        that subject successfully. Please follow the same process to enter the marks for
                                        all subjects for the student.<br/><br/></p></article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-marks-in-cbse-examination by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:35:50 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
