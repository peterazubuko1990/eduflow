...
<head><title>How to add Item Store? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Eduflow add item store"/>
    <meta name="description" content="How to add Item Store?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Item Store?</h3>
                                ...
                                <hr/>
                                <article class="article-body">To add item store, go to <strong>Inventory &gt; Item
                                    store</strong>, here enter <strong>Item Store Name</strong>, <strong>Item Stock
                                    Code</strong> and <strong>Description</strong> and then click on the
                                    <strong>Save</strong> button. You can view this added record in the Item Store List
                                    on the right side of the page.<br/><br/><img
                                            src="../assets/article-media/inventory-add-itemstore.png"
                                            alt="Add item store image" width="1324" height="494"/><br/><br/>To edit item
                                    store click on the <strong>Edit</strong> icon present in item store list and to
                                    delete the item store click on the <strong>Delete</strong> icon present in item
                                    store list.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-item-store by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:32:35 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
