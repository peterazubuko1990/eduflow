...
<head><title>How to add Phone Call Log? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add phone call log in Eduflow"/>
    <meta name="description" content="How to add Phone Call Log?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Phone Call Log?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Office</a></div>
                                <hr/>
                                <article class="article-body">To add phone call log, go to <strong>Front Office &gt;
                                    Phone Call Log</strong> then enter <strong>Name, phone, Date, Description, Next
                                    follow Up Date, Call Duration, Note</strong> and select&nbsp; <strong>Call Type
                                    (incoming/outgoing)</strong> and then click on the <strong>Save</strong> button. You
                                    can view this added record in the <strong>Phone Call Log List</strong> on the right
                                    side of the page.<br/><br/><img
                                            src="../assets/article-media/frontoffice-add-phonecalllog.png"
                                            alt="Add phone call log image" width="1352" height="759"/><br/><br/>To view
                                    phone call log click on <strong>View</strong> icon present at
                                    <strong>Action</strong> column in the phone call log list, at click of this icon
                                    <strong>Details</strong> modal will be open. Here you can see the details of the
                                    phone call log.<br/><br/><img
                                            src="../assets/article-media/frontoffice-detail-phonecalllog.png"
                                            alt="Detail phone call log image" width="1359" height="398"/><br/><br/>To
                                    edit phone call log click on <strong>Edit</strong> icon and to delete phone call log
                                    click on <strong>Delete</strong> icon present in the phone call log list.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-phone-call-log by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:31:49 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
