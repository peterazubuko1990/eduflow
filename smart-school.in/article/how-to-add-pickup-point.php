...
<head><title>How to add pickup point? - eduflow: School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="add pickup point"/>
    <meta name="description" content="How to add pickup point"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add pickup point?</h3>
                                ...
                                <hr/>
                                <article class="article-body"><p>In a "<strong>Eduflow</strong>" a "<strong>transport
                                    pickup point</strong>" refers to the location where students are picked up by the
                                    school's transportation service. This is typically used to provide safe and
                                    efficient transportation for students to and from school, especially in situations
                                    where students live a long way from the school.<br/><br/><img
                                            src="../assets/article-media/pickup%20point%201st%20ss.png" alt=""
                                            width="790" height="390"/><br/><br/></p>
                                    <p>To add <strong>a pickup point,</strong> go to <strong>Transport &gt; Pickup
                                        Point</strong>. The pickup <strong>point list</strong> will be open, and the
                                        "<strong>add</strong>" button will be visible in the right top corner; now click
                                        on the "<strong>add</strong>" button to open <strong>add pickup point
                                            model</strong>, and fill in the details as <strong>pickup point,
                                            latitude, </strong>and<strong> longitude</strong>. For
                                        <strong>latitude</strong> and <strong>longitude</strong>, one option is
                                        available above latitude, which is "<a href="https://www.google.com/maps">Click
                                            here to get latitude and longitude.</a>" With the help of this link, it will
                                        take you to the <strong>Google Maps</strong> page. Now, write here your <strong>pickup
                                            point</strong> so that Google Maps will show you the latitude and longitude
                                        of that pickup point, which you can use and then click on <strong>save</strong>
                                        button.<br/><br/><img
                                                src="../assets/article-media/pickup%20point%202nd%20ss.png" alt=""
                                                width="790" height="390"/><br/><br/></p>
                                    <p>Now, here you can see pickup points in the <strong>Pickup Point List</strong>, in
                                        the list, you can see the column of pickup point <strong>name</strong>, <strong>latitude,</strong>
                                        and<strong> longitude;</strong> and in the <strong>action</strong> column, you
                                        can see the <strong>map</strong> icon, <strong>edit</strong> icon, and <strong>delete</strong>
                                        icon are available.<br/><br/><img
                                                src="../assets/article-media/pickup%20point%203rd%20ss.png" alt=""
                                                width="790" height="390"/><br/><br/></p>
                                    <p>When you click on the <strong>map</strong> icon, it will open the <strong>google
                                        map</strong> of that pickup point with its assigned <strong>latitude</strong>
                                        and <strong>longitude</strong>, and if you want to update the pickup point's
                                        latitude and longitude, just click on the <strong>Edit</strong> button. The edit
                                        model will open, and you can update the details before clicking on the <strong>Save</strong>
                                        button.<br/><br/><img
                                                src="../assets/article-media/pickup%20point%204th%20ss.png" alt=""
                                                width="790" height="390"/><br/><br/>And your edit will be successfully
                                        saved and updated in the <strong>pickup point list. <br/><br/></strong></p>
                                    <p>If you want to <strong>delete</strong> the pickup point, simply click on the
                                        "<strong>delete</strong>" (cross) icon in the <strong>action</strong> column,
                                        the <strong>confirmation</strong> model will appear; click on the
                                        "<strong>OK</strong>" button.<br/><br/><img
                                                src="../assets/article-media/pickup%20point%205h%20ss.png" alt=""
                                                width="790" height="380"/><br/><br/>And your <strong>pickup
...
<!-- Mirrored from smart-school.in/article/how-to-add-pickup-point by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:40:49 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
