...
<head><title>How to add Fees Master? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add fees master in Eduflow"/>
    <meta name="description" content="How to add Fees Master?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Fees Master?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Collection</a></div>
                                <hr/>
                                <article class="article-body"><p>To add fees master, go to <strong>Fees Collection &gt;
                                    Fees Master&nbsp;</strong>(In fees master, we collect fees type and fees group and
                                    after that we assign students for fees group.) then select <strong>Fees Group, Fees
                                        Type</strong> and <strong>Due Date</strong> then enter <strong>Amount</strong>
                                    (fees amount for selected session), <strong>Fine Type</strong> (Percentage/Fix
                                    amount) and then click on <strong>Save</strong> button. You can view this added
                                    record in the<strong> Fees Master list</strong> on the right side of the
                                    page.<br/><br/><img src="../assets/article-media/feescollection-add-feesmaster.png"
                                                        alt="Add Fees master in Eduflow" width="1348"
                                                        height="838"/><br/><br/>To edit fees code click on<strong>
                                        Edit</strong> icon and to delete fees code click on <strong>Delete</strong> icon
                                    present at <strong>Fees Code </strong>column in fees master list.<br/><br/>To
                                    assign/view student click on <strong>Assign/View</strong> student icon present at
                                    <strong>Action</strong> column in the fees master list, it will redirect you in the
                                    <strong>Assigned Fees Group</strong> page, here select <strong>Class,
                                        Section</strong> and <strong>Category,</strong> <strong>Gender</strong> and
                                    <strong>RTE</strong> and then click on<strong> Search</strong> button. The list of
                                    assign fees group will be shown in the below of the page.<br/>Now select student to
                                    whom you want to assign fees group and then click on<strong> Save</strong>
                                    button.<br/><br/><img
                                            src="../assets/article-media/feescollection-feesmaster-assignstudent.png"
                                            alt="Assign fees group image" width="1351" height="782"/></p>
                                    <p>To delete fees master click on <strong>Delete</strong> icon present at <strong>Action</strong>
                                        column in the fees master list.</p></article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-fees-master by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:29:33 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
