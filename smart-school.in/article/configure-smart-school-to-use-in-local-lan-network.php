...
<head><title>Configure Eduflow To Use In Local LAN Network - Eduflow : School Management System by
    Eduflow</title>
    <meta charset="utf-8">
    ...
    <meta name="keywords" content="Configure, local, LAN, Network"/>
    <meta name="description" content="Configure Eduflow To Use In Local LAN Network"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">Configure Eduflow To Use In Local
                                    LAN Network</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Sat, 27 Feb, 2021</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a href="../category/getting-started.php">Getting
                                    Started</a></div>
                                <hr/>
                                <article class="article-body">If you have hosted Eduflow on your local server and
                                    want to use in local LAN (Local Area Network) network then your Eduflow hosting
                                    machine should have static ip address (not be dynamic assigned by your modem DHCP).
                                    Here suppose your server hosting machine have ip address
                                    <strong>192.168.1.2</strong> then when you are installing Eduflow you should
                                    type <span style="color: #27ae60;"><strong>192.168.1.2/myschool/</strong></span> not
                                    <span style="color: #e74c3c;"><strong>localhost/myschool/</strong></span> in browser
                                    address bar otherwise you cannot access Eduflow from other computers in your
                                    LAN and will redirect to <span
                                            style="color: #e74c3c;"><strong>localhost/myschool/</strong></span> url.
                                    <br/><br/>If you have already installed Eduflow using <span
                                            style="color: #e74c3c;"><strong>localhost/myschool/</strong></span> then you
                                    can correct this by editing <strong><span style="color: #3598db;">base_url</span>
                                    </strong>value in file <strong><span style="color: #3598db;">/application/config/config.php</span></strong>
                                    . In this file change <span
                                            style="color: #e74c3c;"><strong>localhost</strong> </span>to your hosting
                                    server <span style="color: #27ae60;"><strong>static ip</strong></span> address like
                                    <strong><span style="color: #27ae60;">192.168.1.2</span></strong> .
                                </article>
...
<!-- Mirrored from smart-school.in/article/configure-smart-school-to-use-in-local-lan-network by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:27:48 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
