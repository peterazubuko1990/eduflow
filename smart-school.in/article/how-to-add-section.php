...
<head><title>How to add Section? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add section in Eduflow"/>
    <meta name="description" content="How to add Section?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Section?</h3>
                                ...
                                <hr/>
                                <article class="article-body">To add section, go to <strong>Academics &gt;
                                    Sections</strong> then enter <strong>Section Name</strong> and then click on
                                    <strong>Save</strong> button. You can view this added record in the <strong>Section
                                        List</strong> on the right side of the page.<br/><br/><img
                                            src="../assets/article-media/acadenic-add-section.png"
                                            alt="Add section image" width="1363" height="474"/><br/><br/>To edit section
                                    click on <strong>Edit</strong> icon and to delete section click on
                                    <strong>Delete</strong> icon present in the section list.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-section by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:28:38 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
