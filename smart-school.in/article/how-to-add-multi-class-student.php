...
<head><title>How to add Multi Class Student? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add multi class student in Eduflow"/>
    <meta name="description" content="How to add Multi Class Student?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Multi Class Student?</h3>
                                ...
                                <hr/>
                                <article class="article-body">To add multi class student, go to <strong>Student
                                    Information &gt; Multi Class Student</strong> then select <strong>Class</strong> and
                                    <strong>Section</strong> and then click on <strong>Search</strong> button. Basically
                                    this feature is for training or coaching centres. Multi class feature is not for
                                    schools or colleges. It is still in experimental stage and we recommend to not use
                                    multi class feature with multi session.&nbsp;<br/><br/><img
                                            src="../assets/article-media/studentinformation-add-multistudent.png"
                                            alt="Add multi student image" width="1348" height="644"/><br/><br/>To add
                                    more classes and sections, click on the <strong>Add</strong> icon and to delete
                                    class and section click on <strong>Remove</strong> button and to update record click
                                    on <strong>Update</strong> button.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-multi-class-student by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:36:56 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
