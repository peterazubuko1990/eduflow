...
<head><title>How to add Design Admit Card? - Smart School : Eduflow System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Design admit card in smart school"/>
    <meta name="description" content="How to add Design Admit Card?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Design Admit Card?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Mon, 06 Dec, 2021</div>
                                </div>
                                ...
                                <hr/>
                                <article class="article-body">To add design admit card, go to <strong>Examination &gt;
                                    Design Admit Card </strong>then enter the <strong>Template, Heading, Title, Exam
                                    Name, School Name </strong>and <strong>Exam Centre, Footer Text</strong> and select
                                    the <strong>Left Logo file,</strong> <strong>Right Logo file, Sign file</strong> and
                                    <strong>Background image</strong> and then <strong>Enable/Disable</strong> Fields on
                                    admit card and then click on <strong>Save</strong> button. You can view this added
                                    record in the Admit Card List on the right side page.<br/><br/><img
                                            src="../assets/article-media/examination-add-designadmitcart.png"
                                            alt="Add design admit card image" width="1346" height="654"/><br/><br/>To
                                    view admit card click on the <strong>View</strong> icon present at
                                    <strong>Action</strong> column in the admit card list, at click of this icon
                                    <strong>Admit Card</strong> modal will be open.<br/><br/><img
                                            src="../assets/article-media/examination-view-admitcard.png"
                                            alt="View admit card" width="1349" height="667"/><br/><br/>To edit admit
                                    card click on <strong>Edit</strong> icon and to delete admit card click on <strong>Delete</strong>
                                    icon present in admit card list.
                                </article>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3">
                        <div class="ad_rsidebar">
                            <div class="sidebanners-ad"><a href="https://1.envato.market/smart_school_android_app"
                                                           target="_blank"><img
                                    src="../assets/front/ads/android-app.jpg" alt="Smart School"></a></div>
                        </div>
                        <div class="sidecard">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12"><p><a href="http://qdocs.in/" target="_blank"><img
                        src="../assets/admin/assets/img/qd-new.png" width="100" alt="Smart School"
...
<!-- Mirrored from smart-school.in/article/how-to-add-design-admit-card by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:37:27 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
