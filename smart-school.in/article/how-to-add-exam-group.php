...
<head><title>How to add Exam Group? - Eduflow : School Management System by QDOCS</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="QDOCS">
    <meta name="keywords" content="Add exam group in Eduflow"/>
    <meta name="description" content="How to add Exam Group?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Exam Group?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Fri, 19 May, 2023</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a href="../category/examinations.php">Examinations</a>
                                </div>
                                <hr/>
                                <article class="article-body">To add exam group, go to <strong>Examination &gt; Exam
                                    Group </strong>then&nbsp;enter <strong>Name</strong>, select the <strong>Exam
                                    Type</strong> and <strong>Description</strong> and then click on
                                    <strong>Save</strong> button. You can view this added record&nbsp; in the&nbsp;
                                    <strong>Exam</strong> <strong>Group List</strong> on the right side of the
                                    page.<br/><br/><img src="../assets/article-media/examination-add-examgroup.png"
                                                        alt="Add exam group image" width="1365" height="445"/><br/><br/>To
                                    add exam click on <strong>Add (+)</strong> icon present at <strong>Action</strong>
                                    column in the exam group list, at click of this icon <strong>Exam list</strong> page
                                    will be open.<br/><br/><img src="../assets/article-media/examination-add-exam.png"
                                                                alt="Add exam image" width="1366"
                                                                height="427"/><br/><br/><br/><img
                                            src="../assets/article-media/examination-examlist.png" alt="Exam list image"
                                            width="1363" height="645"/><br/><br/>To add new exam click on <strong>New
                                        Exam</strong> button present at top right corner of the exam list page, at click
                                    of this button <strong>Exam</strong> modal will be open.<br/><br/><img
                                            src="../assets/article-media/new%20exam.png" alt="" width="1366"
                                            height="661"/><br/><br/>Here fill the detail such as <strong>Exam Name,
                                        Session, Publish, Publish Result, </strong>and if you want to show admit card
                                    roll no. on the marksheet you need to select the admit card roll number or if you
                                    want to show profile roll no. on the mark sheet, simply select the profile roll no.
                                    and enter the <strong>Exam Passing percentage</strong> and finlly fill the <strong>Description </strong>about
                                    the exam and then click on the <strong>Save</strong> button. You can view this added
                                    record on the exam list page.<br/><br/>To edit exam click on <strong>Edit</strong>
                                    icon and to delete exam click on <strong>Delete</strong> icon present in the exam
                                    list page.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-exam-group by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:29:42 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
