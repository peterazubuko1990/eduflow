...
<head><title>How to add the incidents? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Behaviour Records"/>
    <meta name="description" content="Behaviour Records"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add the incidents?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Thu, 11 May, 2023</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a
                                        href="../category/behaviour-records.php">Behaviour Records</a></div>
                                <hr/>
                                <article class="article-body"><p>To add the incidents, go to the <strong>Behaviour
                                    Records &gt; Incidents</strong><strong>.</strong> <strong>The</strong>&nbsp;incident
                                    list page will be open, and now in the top right corner you can see the
                                    <strong>+Add</strong> button showing. With the help of this button, you can add the
                                    incidents.<br/><br/><img src="../assets/article-media/08%20add%20incident.png"
                                                             alt="" width="790" height="377"/><br/><br/></p>
                                    <p>Now, click the <strong>+Add</strong> button to open the Add Incident modal.&nbsp;<br/><br/><img
                                            src="../assets/article-media/09%20add%20incident%20window.png" alt=""
                                            width="790" height="374"/><br/><br/></p>
                                    <p>Now you can see mandatory options to fill out (<strong>Title</strong>, <strong>Point</strong>,
                                        and <strong>Description</strong>).&nbsp;</p>
                                    <p><strong>Title</strong>: Fill in the name of the incident in the title field.&nbsp;
                                    </p>
                                    <p><strong>Point: </strong>In points, you can fill in the points according to the
                                        incidents, whether they are positive or negative. If the incident was positive,
                                        you could award positive points of 10, 15, 20, and so on.&nbsp;</p>
                                    <p><strong>Is This Negative Incident: </strong>If the incident is negative, check
                                        the box to give it negative points Example: -10, -15, and -20,
                                        etc.<br/><br/><img src="../assets/article-media/10%20Negative%20incident.png"
                                                           alt="" width="790" height="336"/></p>
                                    <p>And in the <strong>incident list</strong>, you can see the negative
                                        incidents.<br/><br/><img
                                                src="../assets/article-media/11%20Negative%20point%20show.png" alt=""
                                                width="790" height="345"/></p>
                                    <p><strong>Description</strong>: Here, you can write a detailed overview of that
                                        incident.<br/><br/></p>
                                    <p>After filling out all of the incident details, click the <strong>save</strong>
                                        button in the bottom left corner.&nbsp;<br/><br/><img
                                                src="../assets/article-media/12%20save%20incident.png" alt=""
                                                width="790" height="374"/><br/><br/></p>
                                    <p>By clicking on the <strong>save</strong> button, your details will be saved, and
                                        you can see saved details in the <strong>incident list</strong>.<br/><br/><img
                                                src="../assets/article-media/13%20view%20saved%20incident%20in%20list.png"
                                                alt="" width="790" height="377"/><br/><br/><br/></p>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3">
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    <li><a href="about-behaviour-records.php">About Behaviour Records</a></li>
                                    <li><a href="how-to-check-the-list-of-incidents.html">How to check the list of
                                        incidents?</a></li>
                                    <li><a href="how-to-edit-the-incidents-in-the-incident-list.html">How to edit the
...
<!-- Mirrored from smart-school.in/article/how-to-add-the-incidents by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:30:26 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
