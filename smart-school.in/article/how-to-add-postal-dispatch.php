...
<head><title>How to add Postal Dispatch? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add postal dispatch in Eduflow"/>
    <meta name="description" content="How to add Postal Dispatch?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Postal Dispatch?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Office</a></div>
                                <hr/>
                                <article class="article-body">To add postal dispatch, go to <strong>Front Office &gt;
                                    Postal Dispatch</strong> then enter <strong>To</strong> <strong>Title, Reference No,
                                    Address, Note</strong>&nbsp;and <strong>From Title, Date</strong> and<strong> Attach
                                    Document</strong> and then click on the<strong> Save</strong> button. You can view
                                    this added record in the <strong>Postal Dispatch List</strong> on the right side of
                                    the page.<br/><br/><img
                                            src="../assets/article-media/frontoffice-add-postaldispatch.png"
                                            alt="Add postal dispatch image" width="1358" height="711"/><br/><br/>To view
                                    postal dispatch click on <strong>View</strong> icon present at
                                    <strong>Action</strong> column in the postal dispatch list, at click of this icon
                                    <strong>Details</strong> modal will be open. Here you can see the details of the
                                    postal dispatch.<br/><br/><img
                                            src="../assets/article-media/frontoffice-detail-postaldispatch.png"
                                            alt="Detail postal dispatch" width="1360" height="400"/><br/><br/>To
                                    download upload file click on <strong>Download</strong> icon and to edit postal
                                    dispatch click on <strong>Edit</strong> icon and to delete postal dispatch click on
                                    <strong>Delete</strong> icon present in the postal dispatch list.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-postal-dispatch by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:40:27 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
