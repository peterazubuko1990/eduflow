...
<head><title>How to add News? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add news in Eduflow"/>
    <meta name="description" content="How to add News?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add News?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    CMS</a></div>
                                <hr/>
                                <article class="article-body">To add news, go to<strong> Front CMS &gt; News</strong>
                                    then click on <strong>Add</strong> button present at top right corner in the news
                                    list page, then&nbsp;enter news <strong>Title, Date, Description, Add Media, SEO
                                        Detail (Meta Title, Meta Keyword, Meta Description)</strong> and select <strong>Sidebar
                                        Setting</strong> to show/hide sidebar and select <strong>Featured Image</strong>
                                    (you can delete feature image click on <strong>Delete</strong> button) and then
                                    click on<strong> Save</strong> button.<br/><br/><img
                                            src="../assets/article-media/frontcms-add-news.png" alt="add news image"
                                            width="1348" height="1029"/><br/><br/>Here you can view added News/Notices&nbsp;
                                    in the <strong>News List</strong> page.<br/><br/><img
                                            src="../assets/article-media/frontcms-list-news.png" alt="News list image"
                                            width="1361" height="531"/><br/><br/>To edit news click on
                                    <strong>Edit</strong> icon and to delete news click on <strong>Delete</strong> icon
                                    present in the news list.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-news by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:37:44 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
