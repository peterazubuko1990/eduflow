...
<head><title>Email Send Not Working - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="email, sendmail, smtp"/>
    <meta name="description" content="Email Send Not Working"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">Email Send Not Working</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Fri, 24 Jun, 2022</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a
                                        href="../category/common-issues-troubleshooting.php">Common Issues &
                                    Troubleshooting</a></div>
                                <hr/>
                                <article class="article-body">After adding student or staff if you found there is no
                                    email is sending by system then there may be email configuration issue on your
                                    server / Eduflow.<br/><br/>In Eduflow we have used phpmailer <span
                                            style="color: #3598db;"><strong><a
                                            href="https://github.com/PHPMailer/PHPMailer" target="_blank"
                                            rel="noopener">https://github.com/PHPMailer/PHPMailer </a></strong></span>library
                                    which is used by many popular php application like WordPress, Drupal, SugarCRM, Yii,
                                    Joomla etc. <br/><br/>By default <strong>SendMail</strong> is set as <strong>Email
                                        Engine</strong> in <strong>General Settings &gt; Email Setting</strong>.
                                    SendMail can only work and send emails if you cpanel hosting supports it. If
                                    SendMail not sending email then contact to your hosting provider. Since SendMail is
                                    easiest but less reliable so check email recipient account <strong>Spam</strong>
                                    folder because sometimes SendMail sent emails detected as spams (if using SendMail).
                                    Another and best option is to use <strong>SMTP</strong> as email engine. You can use
                                    <strong>Gmail</strong> or any other free SMTP service provider to use SMTP email
                                    engine.<br/>​<br/>If you are using your hosting smtp or any other provider smtp
                                    service then check their documentation for smtp settings.<br/><br/><strong>Gmail
                                        SMTP configuration -</strong><br/><br/>To configure gmail account first you have
                                    to create app password for SMTP service, Please check following steps to generate
                                    app password-<br/><br/>1. Go to your Google Account.<br/>2. On the left navigation
                                    panel, choose Security.<br/>3. On the 'Signing in to Google' panel, choose App
                                    passwords. If you don&rsquo;t see this option:<br/>
                                    <ul>
                                        <li>2-Step Verification is not set up for your account</li>
                                        <li>2-Step Verification is set up for security keys only</li>
                                        <li>Your account is through work, school or other organisation</li>
                                        <li>You&rsquo;ve turned on Advanced Protection for your account</li>
                                    </ul>
                                    4. At the bottom, choose Select app and choose the app that you&rsquo;re using.<br/>5.
                                    Choose Select device and choose the device that you're using.<br/>6. Choose
                                    Generate.<br/>7. Follow the instructions to enter the app password. The app password
                                    is the 16-character code in the yellow bar on your device.<br/>8. Choose
                                    Done.<br/><br/><br/>After generating gmail app password for SMTP service enter
                                    credentials in Eduflow SMTP email configuration-<br/><br/><strong><code><span
                                            style="color: #e74c3c;">SMTP Username = your gmail email id</span></code></strong><br/><strong><code><span
                                            style="color: #e74c3c;">SMTP Password = Generated App Password</span></code></strong><br/><strong><code><span
                                            style="color: #e74c3c;">SMTP Server = smtp.gmail.com</span></code></strong><br/><strong><code><span
                                            style="color: #e74c3c;">SMTP Port = 587</span></code></strong><br/><strong><code><span
                                            style="color: #e74c3c;">SMTP Security = TLS<br/>SMTP Auth = ON</span></code></strong><br/><br/><br/><br/><strong><em>Note:
                                        After configuring email setting please check you have enabled email notification
                                        settings from System Settings &gt; Notification Setting.</em></strong></article>
...
<!-- Mirrored from smart-school.in/article/email-send-not-working by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:34:16 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
