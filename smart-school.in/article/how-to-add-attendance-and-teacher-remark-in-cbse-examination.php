...
<head><title>How to add attendance and teacher remark in CBSE Examination? - Eduflow : School Management System by
    Eduflow</title>
    <meta charset="utf-8">
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add attendance and teacher remark
                                    in CBSE Examination?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Examination</a></div>
                                <hr/>
                                <article class="article-body"><p>To add the <strong>Attendance</strong>, go to the
                                    <strong>CBSE Examination &gt; Exam</strong>. On the exam list, in action column you
                                    can see the <strong>Exam Attendance</strong> icon beside of exam
                                    marks.<br/><br/><img src="../assets/article-media/04i%20AT.png" alt="" width="1366"
                                                         height="734"/><br/><br/></p>
                                    <p>Now click on the exam attendance icon, <strong>Exam Attendance model</strong>
                                        will be open.<br/><br/><img src="../assets/article-media/05i%20AT.png" alt=""
                                                                    width="1366" height="734"/><br/><br/>On this model,
                                        you will first see <strong>Total Attendance Days</strong>, which indicates the
                                        number of days the school has been in session. Below that, you can view student
                                        details such as <strong>Admission Number, Roll Number, Student Name, Class,
                                            Section, Father Name, Gender</strong>, and a field for <strong>Total Present
                                            Days</strong>. Enter the number of days the student was present in school
                                        and click on the <strong>save</strong> button to mark their attendance
                                        successfully.<br/><br/><br/></p>
                                    <p>To add <strong>Teacher Remark</strong>, go to the <strong>CBSE Examination &gt;
                                        Exam</strong>. On the exam list, in action column you can see the <strong>Teacher
                                        Remark</strong> icon beside of <strong>Exam Attendance</strong>.<br/><br/><img
                                            src="../assets/article-media/06i%20TR.png" alt="" width="1366"
                                            height="734"/><br/><br/></p>
                                    <p>Now click on the <strong>Teacher Remark</strong> icon, <strong>Teacher
                                        Remark</strong> model will be open.<br/><br/><img
                                            src="../assets/article-media/NNN213.png" alt="" width="1920"
                                            height="955"/><br/><br/>On this model, you can view student details such as
                                        <strong>Admission Number, Roll Number, Class, Section, Student
                                            Nam</strong><strong>e, Marks, Gender</strong>, and the last column will be
                                        for <strong>Remarks</strong>. The teacher can give remarks to the students based
                                        on their performance in the exam and click on the <strong>save</strong> button
                                        and the remark for the student will be successfully saved.</p></article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-attendance-and-teacher-remark-in-cbse-examination by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:35:52 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
