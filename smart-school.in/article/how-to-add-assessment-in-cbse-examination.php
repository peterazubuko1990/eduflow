...
<head><title>How to add assessment in CBSE Examination? - eduflow: School Management System by Eduflow</title>
    <meta charset="utf-8">
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add assessment in CBSE
                                    Examination?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Examination</a></div>
                                <hr/>
                                <article class="article-body"><p>To add the assessment, go to <strong>CBSE Examination
                                    &gt; Assessment.</strong> The Assessment list will be displayed. On the top right
                                    corner add button showing, simply click on <strong>Add</strong> button, Add
                                    Assessment model will be open.<br/><br/><img src="../assets/article-media/01x.png"
                                                                                 alt="" width="1366" height="774"/><br/><br/>
                                </p>
                                    <p>Now fill the name of assessment and right the description about the assessment
                                        and in below you can fill the assessment type (it could be theory and practical
                                        etc.), fill the code of Assessment Type, and fill the Maximum Marks, Pass
                                        Percentage and the description. If you want to more assessment type simply just
                                        click on Add More button, the multiple inputs will be open.<br/><br/><img
                                                src="../assets/article-media/02x.png" alt="" width="1366" height="734"/><br/><br/>
                                    </p>
                                    <p>And if you want to delete the multiple inputs, simply just click on <strong>Red
                                        Cross </strong>icon which is showing on the right side of input and the inputs
                                        will be delete successfully.<br/><br/><img src="../assets/article-media/03x.png"
                                                                                   alt="" width="1366"
                                                                                   height="734"/><br/><br/></p>
                                    <p>After add the all details of the assessment, just click on <strong>save</strong>
                                        button which is showing on the bottom right corner and details will save in
                                        Assessment list successfully.<br/><br/>To <strong>Edit</strong> the assessment,
                                        go to <strong>CBSE Examination &gt; Assessment</strong>. The assessment list
                                        will be displayed, and on the right side, the <strong>Action</strong> column
                                        will be visible. To initiate the edit, simply click on the pencil icon, which
                                        will open the <strong>Edit Assessment</strong> model.<br/><br/><img
                                                src="../assets/article-media/05x.png" alt="" width="1366" height="734"/><br/><br/>Now
                                        update the relevant details of assessment and click on <strong>save</strong>
                                        button, your details will be update successfully on the assessment
                                        list.<br/><br/>To delete the Assessment, simply click on <strong>Delete</strong>
                                        icon which is showing in action column, <strong>Delete Confirmation</strong>
                                        model will be open.<br/><br/><img src="../assets/article-media/06x.png" alt=""
                                                                          width="1366" height="761"/><br/><br/></p>
                                    <p>Now just click on <strong>OK</strong> button and your assessment details will be
                                        deleted successfully.</p></article>
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="how-to-add-assessment-in-cbse-examination.html">How to add assessment
                                        in CBSE Examination?</a></li>
...
<!-- Mirrored from smart-school.in/article/how-to-add-assessment-in-cbse-examination by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:28:52 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
