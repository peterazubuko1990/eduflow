...
<head><title>How to add marks in exam? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add marks exam in Eduflow"/>
    <meta name="description" content="How to add marks in exam?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add marks in exam?</h3>
                                ...
                                <hr/>
                                <article class="article-body">To add subject marks, go to <strong>Examination &gt; Exam
                                    Group</strong> then click on <strong>Add</strong> icon present at
                                    <strong>Action</strong> column in exam group list, at click of this icon exam list
                                    page will be open. <br/><br/><img
                                            src="../assets/article-media/examination-examlist-exammark.png"
                                            alt="Exam mark image " width="1366" height="427"/><br/><br/>Here click on
                                    <strong>Exam Marks</strong> icon present at <strong>Action</strong> column in the
                                    exam list page, at click of this <strong>Exam Subject</strong> modal will be open.
                                    <br/><br/><img src="../assets/article-media/examination-add-exammark.png"
                                                   alt="Exam mark image" width="1366" height="631"/><br/><br/><br/>Here
                                    click on the <strong>Exam Marks</strong> icon present at <strong>Enter
                                        Marks</strong> column in the exam subjects, at click of this icon subject modal
                                    will be open.<br/><br/><img src="../assets/article-media/examination-entermark.png"
                                                                alt="Enter mark image" width="1366"
                                                                height="644"/><br/><br/>Here select the <strong>Class,
                                        Section</strong> and <strong>Session</strong> and then click on
                                    <strong>Search</strong> button. You can also download the import file from right
                                    side clicking on <strong>Download</strong> Import File button. After importing csv
                                    file marks will be fill in marks input box, if you want you edit and check marks and
                                    then upload the file and then click on <strong>Submit</strong> button.<br/><br/><img
                                            src="../assets/article-media/examination-add-entermarks.png"
                                            alt="Enter mark image" width="1366" height="656"/></article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-marks-in-exam by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:37:25 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
