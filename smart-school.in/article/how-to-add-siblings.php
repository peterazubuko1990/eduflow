...
<head><title>How to add Siblings? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="siblings"/>
    <meta name="description" content="How to add multiple siblings"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Siblings?</h3>
                                ...
                                <hr/>
                                <article class="article-body">You can add multiple siblings by adding student as a
                                    sibling to each other&rsquo;s, but you can only add sibling to those students in
                                    which no sibling is already added, so to add multiple siblings e.g. A, B, C, D
                                    follow these steps-<br/><br/>
                                    <ol>
                                        <li>Select student to which you want to add sibling e.g. if you want student
                                            <strong>B</strong> as sibling of student <strong>A</strong> so select
                                            student <strong>A</strong> profile (note: student <strong>A</strong> should
                                            <strong>not have any sibling</strong>).
                                        </li>
                                        <li>Go to student <strong>A</strong> profile and click on <strong>Edit</strong>
                                            button, then add sibling, student<strong> B</strong> here and click on
                                            <strong>Save</strong> button.
                                        </li>
                                        <li>Now, edit student <strong>C</strong> profile and add student
                                            <strong>A</strong> or student <strong>B</strong> as sibling here and click
                                            on <strong>Save</strong> button.
                                        </li>
                                        <li>Same as edit student <strong>D</strong> profile and add student<strong>
                                            A</strong> or student <strong>B</strong> or student <strong>C</strong> as
                                            sibling here and click on <strong>Save</strong> button and so on.
                                        </li>
                                    </ol>
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-siblings by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:36:45 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
