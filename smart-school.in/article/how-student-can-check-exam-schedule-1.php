...
<head><title>How Student can check Exam Schedule? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="how Student can check Exam Schedule in Eduflow"/>
    <meta name="description" content="How Student can check Exam Schedule?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How Student can check Exam
                                    Schedule?</h3>
                                ...
                                <hr/>
                                <article class="article-body">To check exam schedule, go to sidebar menu and
                                    follow<strong> Examinations &gt; Exam Schedule</strong>. Here you can see all exam
                                    list.<br/><br/><img src="../assets/article-media/student-examlist.png"
                                                        alt="student exam list image" width="1353"
                                                        height="474"/><br/><br/>To view exam schedule click on <strong>View</strong>
                                    icon present at <strong>Action</strong> column in exam schedule page, at click of
                                    this icon Examination modal will be open. Here you can see exam schedule
                                    details.<br/><br/><img src="../assets/article-media/student-exam-details.png" alt=""
                                                           width="1366" height="477"/></article>
...
<!-- Mirrored from smart-school.in/article/how-student-can-check-exam-schedule-1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:41:31 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
