...
<head><title>How to add the exam grade in CBSE Examination? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add the exam grade in CBSE
                                    Examination?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Examination</a></div>
                                <hr/>
                                <article class="article-body"><p>To add Exam Grade, go to <strong>CBSE Examination &gt;
                                    Exam Grade</strong>. After click on exam grade, the <strong>Exam Grade List</strong>
                                    will be open on the right side.<br/><br/><img
                                            src="../assets/article-media/ki756.png" alt="" width="1423"
                                            height="775"/><br/><br/>To <strong>Add Exam Grade</strong>, simply click on
                                    the Add button which is located at top right corner, Add Grade model will be
                                    open.<br/><br/><img src="../assets/article-media/02p.png" alt="" width="1366"
                                                        height="734"/><br/><br/></p>
                                    <p>Please enter the <strong>Grade Title</strong> and <strong>Description</strong> of
                                        the <strong>Grade</strong>. Below, you will see multiple input fields. First,
                                        enter the <strong>Grade</strong>. Then, set the <strong>Maximum </strong>and
                                        <strong>Minimum Percentages</strong> for that grade. Finally, include any
                                        remarks.<br/><br/>You can also add the multiple input field, now click on the
                                        <strong>Add More</strong> button, multiple input field will open in
                                        below.<br/><br/><img src="../assets/article-media/03p.png" alt="" width="1366"
                                                             height="734"/><br/><br/></p>
                                    <p>&nbsp;</p>
                                    <p>To <strong>Edit Grade</strong>, go to the action column, here you can see one
                                        pencil icon, just click on edit (pencil) icon, <strong>Edit Grade</strong> model
                                        will be open.<br/><br/><img src="../assets/article-media/04p.png" alt=""
                                                                    width="1366" height="734"/><br/><br/></p>
                                    <p>Now update the details of grade and click on <strong>save</strong> button which
                                        is showing bottom right corner, the grade details will be update successfully,
                                        and you can see them on the exam grade list.<br/><br/><img
                                                src="../assets/article-media/05p.png" alt="" width="1366" height="734"/><br/><br/>
                                    </p>
                                    <p>To delete the grade from the exam grade list, go to the action column, here you
                                        can see one delete (cross) icon will showing.<br/><br/><img
                                                src="../assets/article-media/06p.png" alt="" width="1366" height="774"/><br/><br/>
                                    </p>
                                    <p>Now click on <strong>Delete</strong> icon, delete confirmation model will be
                                        open.<br/><br/><img src="../assets/article-media/07p.png" alt="" width="1366"
                                                            height="735"/><br/><br/></p>
                                    <p>Now click on <strong>OK</strong> button, so grade will be deleted successfully
                                        from the exam grade list.</p></article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-the-exam-grade-in-cbse-examination by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:35:44 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
