...
<head><title>How to add Department? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add department in Eduflow"/>
    <meta name="description" content="How to add Department?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Department?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Resource</a></div>
                                <hr/>
                                <article class="article-body">To add department, go to <strong>Human Resource &gt;
                                    Department</strong> then enter <strong>Name</strong> and then click on<strong>
                                    Save</strong> button. You can view this added record in the <strong>Department
                                    List</strong> on the right side of the page.<br/><br/><img
                                        src="../assets/article-media/humanresource-add-department.png"
                                        alt="Add department image" width="1366" height="569"/><br/><br/>To edit
                                    department click on<strong> Edit</strong> icon and to delete department click on
                                    <strong>Delete</strong> icon present in the Department list.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-department by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:31:56 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
