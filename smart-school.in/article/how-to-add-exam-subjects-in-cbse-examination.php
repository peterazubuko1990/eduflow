...
<head><title>How to add exam subjects in CBSE Examination? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add exam subjects in CBSE
                                    Examination?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Tue, 05 Dec, 2023</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Examination</a></div>
                                <hr/>
                                <article class="article-body"><p>To add a subject, go to <strong>CBSE Examination &gt;
                                    Exam</strong>. On the right side, in action column, you will see multiple icons. The
                                    second icon is for <strong>Exam Subjects</strong>.<br/><br/><img
                                            src="../assets/article-media/01t.png" alt="" width="1366"
                                            height="734"/><br/><br/></p>
                                    <p>Simply click on that icon, <strong>Add Exam Subject</strong> model will be
                                        open.<br/><br/><img src="../assets/article-media/02t.png" alt="" width="1366"
                                                            height="734"/><br/><br/></p>
                                    <p>In this model you can see the details as exam name and class, section, now for
                                        add the exam subject, <strong>Add Exam Subject</strong> button showing at the
                                        right side of the model, simply just click on this button to open the multiple
                                        field for adding subject.<br/><br/><img src="../assets/article-media/NN12.png"
                                                                                alt="" width="1920"
                                                                                height="955"/><br/><br/>To add a
                                        subject, click on <strong>Select</strong>, and a drop-down menu will appear
                                        where you can view the subject list. Simply choose one of the subjects and In
                                        the <strong>Assessment </strong>column, you can find options for both theory and
                                        practical, each accompanied by its respective checkbox. When you select the
                                        checkbox, the marks for both theory and practical subjects will be displayed in
                                        the marksheet. If you do not check the checkbox for either theory or practical,
                                        the marks will not be shown in the marksheet. Now, select the <strong>Exam
                                            Date</strong>, pick the <strong>Start Time</strong>, enter the <strong>Duration</strong>
                                        in minutes, and finally, choose the <strong>Room</strong> number where the
                                        examination will be held. Repeat this process for all subjects, then click on
                                        the <strong>Save</strong> button to successfully add your subjects. If you want
                                        to remove any of these fields, click on the <strong>Red Cross</strong> icon
                                        located on the right side of the model.<br/><br/></p>
                                    <p><strong>Note :-</strong> When you creating two or more exams, such as Exam One
                                        and Exam Two, and linking them, make sure to add the same subject to both exams.
                                        If you don't keep the same subject in both exams, the marksheet may appear
                                        irrelevant when you print it.</p></article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-exam-subjects-in-cbse-examination by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:35:49 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
