...
<head><title>About CBSE Examination - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">About CBSE Examination</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.html"><i class="fa fa-home"></i></a><a
                                        href="../articles.html">Articles</a><a href="../category/cbse-examination.html">CBSE
                                    Examination</a></div>
                                <hr/>
                                <article class="article-body"><p>This examination adopts a distinct approach to
                                    assessing students, encompassing modules such as terms, observation, observation
                                    parameter, assessment, marksheet templates, subject marks reports, and template
                                    marks reports.</p>
                                    <p>In this examination, you have the option to create multiple terms for various
                                        exams, and these multiple terms, along with the exams, can be printed on the
                                        marksheet. Overall, there are no limitations to the number of terms you can
                                        create within a single year for this examination.</p>
                                    <p>Assessment plays a crucial role in evaluating students' knowledge, skills, and
                                        understanding of the subjects. Assessment in this examinations aims to provide a
                                        comprehensive view of students' academic performance and holistic development.
                                        It emphasizes not only subject knowledge but also practical knowledge.</p>
                                    <p>The role of observation is integral to upholding the integrity and credibility of
                                        the assessment process. It contributes to a transparent and reliable evaluation
                                        system that is essential for students.</p>
                                    <p>Observation parameters refer to the specific criteria and aspects that are
                                        monitored, evaluated, and assessed by external observers during the conduct of
                                        examinations.</p>
                                    <p><strong><br/>CBSE Examination Workflow : -</strong> <br/><br/>In the CBSE
                                        Examination, the following steps should be followed :-</p>
                                    <ol>
                                        <li>Create the term.</li>
                                        <li>Create the assessments.</li>
                                        <li>Before creating observations, establish the observation parameters.</li>
                                        <li>Create the observations.</li>
                                        <li>Assign the observations and link the marks to them.</li>
                                        <li>Create the exam grade for the examination.</li>
                                        <li>Create the exam and assign it to the students.</li>
                                        <li>Enter the subjects and their respective marks.</li>
                                        <li>Record the attendance and teacher remarks.</li>
                                        <li>To publish exam, you need to edit the exam and check the checkbox of publish
                                            exam.
                                        </li>
                                        <li>To publish result, you need to edit the exam and check the checkbox of
                                            publish result.
                                        </li>
                                        <li>To print the mark sheet, create the template first.</li>
                                        <li>Link the exam with the template.</li>
                                        <li>Now, you can print the mark sheet.</li>
                                        <li>To check the result student side, login student panel, go to CBSE
                                            Examination &gt; Exam Result.
                                        </li>
                                    </ol>
                                </article>
...
<!-- Mirrored from smart-school.in/article/about-cbse-examination by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:28:47 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
