...
<head><title>Can I use Eduflow on localhost or local LAN network? - Eduflow : School Management System by
    Eduflow</title>
    <meta charset="utf-8">
    ...
    <meta name="keywords" content="localhost, local, LAN, network, access"/>
    <meta name="description" content="Can I use Eduflow on localhost or local LAN network?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">Can I use Eduflow on localhost or
                                    local LAN network?</h3>
                                ...
                                <hr/>
                                <article class="article-body">Yes, you can use Eduflow on localhost installation
                                    (using XAMPP or WAMP) and <strong>access it in your local LAN</strong> (Local Area
                                    Network) from other pc in network. How to configure Eduflow for local LAN
                                    network please <a title=" Configure Eduflow To Use In Local LAN Network"
                                                      href="configure-smart-school-to-use-in-local-lan-network.php">check
                                        this article</a>.
                                </article>
...
<!-- Mirrored from smart-school.in/article/can-i-use-smart-school-on-localhost-or-local-lan-network by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:34:40 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
