...
<head><title>How to add Class Timetable? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add class timetable in Eduflow"/>
    <meta name="description" content="How to add Class Timetable?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Class Timetable?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a href="../category/academics.php">Academics</a>
                                </div>
                                <hr/>
                                <article class="article-body">To add class timetable, go to <strong>Academic &gt; Class
                                    Timetable</strong> click on <strong>Add</strong> button present at top right corner
                                    of the page, then select <strong>Class, Section, Subject group</strong> and then
                                    click on <strong>Search</strong>&nbsp;button. The list of 7 days will be shown in
                                    the below of the page.<br/><br/><img
                                            src="../assets/article-media/academic-add-classtimetable.png"
                                            alt="Add class timetable image" width="1361" height="406"/><br/><br/>
                                    <p>Now, you can view a <strong>select parameter to generate a timetable
                                        quickly</strong>. Here you can quickly generate timetables for each class and
                                        day.<br/><br/><img src="../assets/article-media/NN17.png" alt="" width="1920"
                                                           height="955"/><br/><br/>To quickly generate a timetable,
                                        enter some parameters and click on the <strong>+Add New</strong> button to add
                                        multiple subjects, add <strong>subject</strong>, and add
                                        <strong>teacher.</strong> To generate a quick timetable, add <strong>Period
                                            Start Time</strong>, <strong>Duration </strong>(in minutes), <strong>Interval</strong>
                                        (in minutes), and <strong>Room</strong> <strong>No</strong>., then click on
                                        <strong>Apply</strong>. When you click apply, you can quickly view the generated
                                        time table. If you want to change the <strong>time from</strong>, <strong>time
                                            to</strong>, or <strong>room number</strong>, you can do so manually, then
                                        click the <strong>Save</strong> button showing in the bottom right corner.</p>
                                    <img src="../assets/article-media/NN%2018.png" alt="" width="1920"
                                         height="955"/><br/><br/>To delete class timetable click on
                                    <strong>Delete</strong> button showing at <strong>Action</strong> column,
                                    confirmation model will be open.<br/><br/><img
                                            src="../assets/article-media/NN19.png" alt="" width="1920"
                                            height="839"/><br/><br/>Now click on <strong>OK</strong> button, timetable
                                    of that subject will be delete successfully.<br/><br/>To view created time table,
                                    here select <strong>Class</strong> and <strong>Section</strong> and then click on
                                    <strong>Search</strong> button. The list of searched record will be shown in the
                                    below of the page.<br/><br/><img
                                            src="../assets/article-media/academic-view-classtimetable.png"
                                            alt="View class timetable image" width="1348" height="648"/></article>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3">
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    <li><a href="about-academics.php">About Academics</a></li>
                                    ...
                                    <li><a href="how-to-promote-student.html">How to Promote Student?</a></li>
                                    <li><a href="how-student-can-view-class-timetable.php">How student can view class
                                        timetable?</a></li>
                                </ul>
...
<!-- Mirrored from smart-school.in/article/how-to-add-class-timetable by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:35:32 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
