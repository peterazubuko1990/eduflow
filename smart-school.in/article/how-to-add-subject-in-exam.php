...
<head><title>How to add subject in Exam? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add subject exam in Eduflow"/>
    <meta name="description" content="How to add subject in Exam?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add subject in Exam?</h3>
                                ...
                                <hr/>
                                <article class="article-body">To add exam subject, go to <strong>Examination &gt; Exam
                                    Group</strong> then click on <strong>Add</strong> icon present at
                                    <strong>Action</strong> column in exam group list, at click of this icon <strong>Exam
                                        List</strong> page will be open.<br/><br/><img
                                            src="../assets/article-media/examination-icon-examsubject.png"
                                            alt="Exam subject icon image" width="1366" height="428"/><br/><br/>Now click
                                    on the <strong>Exam Subject</strong> icon present at <strong>Action</strong> column
                                    in the exam list page, at click of this icon <strong>Add Subjects</strong> modal
                                    will be open.<br/><br/><img
                                            src="../assets/article-media/examination-add-examsubject.png"
                                            alt="Add exam subject image" width="1366" height="427"/><br/><br/>Here click
                                    on the <strong>Add Exam Subject</strong> button present in the right side of the add
                                    subject page, at click of this button new column box will be added then fill the
                                    details <strong>Subject, Date, Time, Duration, Credit Hours</strong> (If you are
                                    using GPA grading system exam type, then enter the credit hour otherwise ignore
                                    it.),<strong> Room No., Marks (Max)</strong> and<strong> marks (Min.)</strong> and
                                    then click on <strong>Save</strong> button. If you want delete any subject then
                                    click on <strong>Remove</strong> icon.<br/><br/><img
                                            src="../assets/article-media/examination-add-subjects.png"
                                            alt="Add subject image" width="1366" height="650"/></article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-subject-in-exam by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:29:45 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
