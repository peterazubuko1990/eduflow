...
<head><title>How to add Subject Group? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add subject group in Eduflow"/>
    <meta name="description" content="How to add Subject Group?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Subject Group?</h3>
                                ...
                                <hr/>
                                <article class="article-body">To add subject group, go to <strong>Academic &gt; Subject
                                    Group</strong> then enter subject group <strong>Name</strong> then select <strong>Class,
                                    Section</strong>,<strong>Subjects</strong> and enter <strong>Description</strong>
                                    and then click on the <strong>Save</strong> button. You can view this added record
                                    in the <strong>Subject Group List</strong> on the right side of the
                                    page.<br/><br/><img src="../assets/article-media/academic-add-subjectgroup.png"
                                                        alt="Add subject group image" width="1348"
                                                        height="664"/><br/><br/>To edit subject group click on <strong>Edit</strong>
                                    icon and to delete subject group click on <strong>Delete</strong> icon present in
...
<!-- Mirrored from smart-school.in/article/how-to-add-subject-group by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:35:27 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
