...
<head><title>How to add Copy Old Lessons? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Copy Old Lessons"/>
    <meta name="description" content="How to add Copy Old Lessons"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Copy Old Lessons?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Thu, 23 Feb, 2023</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a href="../category/lesson-plan.php">Lesson
                                    Plan</a></div>
                                <hr/>
                                <article class="article-body"><p>If you have not yet created a <strong>Lesson
                                    Plan</strong> for the current session, you can copy <strong>Old Lesson Plan</strong>
                                    and manage the current lesson plan.&nbsp;</p>
                                    <p>To add <strong>Copy Old Lessons</strong> go to <strong>Lesson Plan</strong> &gt;
                                        <strong>Copy Old Lessons</strong> then Select the &nbsp;preferred <strong>Session</strong>,
                                        <strong>Class, Section</strong>, <strong>Subject Group</strong>,
                                        <strong>Subject</strong> and click on <strong>Search</strong>
                                        button.<br/><br/><img src="../assets/article-media/01%20ss.png" alt=""
                                                              width="790" height="372"/><br/><br/>Based on the above
                                        search, the subject for which you selected related details will be shown in the
                                        section below.<br/><br/><img src="../assets/article-media/02%20ss.png" alt=""
                                                                     width="790" height="387"/><br/><br/></p>
                                    <p>Now, select the <strong>lesson</strong> and <strong>topic</strong> by checking
                                        the <strong>checkbox</strong>, which is shown in the below left side, and in the
                                        below right side, you can select <strong>the class, section, subject
                                            group</strong>, and <strong>subject</strong> where you want to update the
                                        <strong>lesson plan</strong>. After you click on the <strong>save</strong>
                                        button.<br/><br/><img src="../assets/article-media/03%20ss.png" alt=""
                                                              width="790" height="387"/><br/><br/>It will redirect you
                                        in <strong>lesson module </strong>and you can see in the lesson list that your
                                        copied lesson will be successfully updated in the current session.<br/><br/><img
                                                src="../assets/article-media/04%20ss.png" alt="" width="790"
                                                height="377"/><br/><br/></p>
                                    <p>You can <strong>edit</strong> the lesson by clicking the edit button showing in
                                        <strong>Action</strong> column, just click on <strong>Edit</strong> button, edit
                                        module will be open now here you can update the lesson and click on
                                        <strong>Save</strong> button your lesson will be update successfully.</p>
                                    <p><img src="../assets/article-media/05%20ss.png" alt="" width="790"
                                            height="377"/><br/><br/></p>
                                    <p>To <strong>Delete</strong> the lesson, simply click on the
                                        <strong>delete</strong> icon, confirmation model will be open.<br/><br/><img
                                                src="../assets/article-media/06%20ss.png" alt="" width="790"
                                                height="375"/></p>
                                    <p>Now click on <strong>OK</strong> button, your lesson will be
                                        <strong>Delete</strong> successfully.</p>
                                    <p><br/><br/></p>
                                    <p><br/><br/><br/><br/></p></article>
                            ...
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="how-to-check-lesson-plan-schedule.html">How to check Lesson Plan
                                        schedule?</a></li>
                                    <li><a href="how-to-add-copy-old-lessons.html">How to add Copy Old Lessons?</a></li>
                                </ul>
...
<!-- Mirrored from smart-school.in/article/how-to-add-copy-old-lessons by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:40:14 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
