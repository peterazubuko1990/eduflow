...
<head><title>How to add teacher 's review? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="How to add teacher 's review in Eduflow"/>
    <meta name="description" content="How to add teacher 's review?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add teacher 's review?</h3>
                                ...
                                <hr/>
                                <article class="article-body"><p>To add teacher review, go to sidebar menu and click on
                                    <strong>Teacher Review</strong> link then click on <strong>Add</strong> icon present
                                    in <strong>Rate</strong> column in the teacher reviews page, at click of this icon
                                    Rate modal will be open.<br/><br/><img
                                            src="../assets/article-media/student-reviewlist.png"
                                            alt="Student Review List Image" width="1366" height="660"/></p>
                                    <p>Here add <strong>Rating</strong> and enter <strong>Comment</strong> and then
                                        click on <strong>Save</strong> button.<br/><br/><img
                                                src="../assets/article-media/student-teacher-addrating.png"
                                                alt="Student Teacher RatingImage" width="1366" height="617"/></p>
                                </article>
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="how-student-can-view-homework-list-1.php">How student can view homework
                                        list?</a></li>
...
<!-- Mirrored from smart-school.in/article/how-to-add-teacher-s-review by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:41:33 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
