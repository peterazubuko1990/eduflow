...
<head><title>How to add Barcode in student id card and his profile? - Eduflow : School Management System by
    Eduflow</title>
    <meta charset="utf-8">
    ...
    <meta name="keywords" content="add barcode in Student Profile"/>
    <meta name="description" content=" add barcode in Student Profile"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Barcode in student id card
                                    and his profile?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Wed, 06 Dec, 2023</div>
                                </div>
                                ...
                                <hr/>
                                <article class="article-body"><p>To add the <strong>Barcode</strong> to the student id
                                    ...
                                    <strong>ID Card Scan Code.</strong></p>
                                    <p><img src="../assets/article-media/BARCODE-111.png" alt="" width="1330"
                                            height="660"/><br/><br/></p>
                                    <p>In the<strong> ID card scan code</strong> section, you will find two available
                                        options for scan type: the first is <strong>Barcode</strong>, and the second
                                        option is <strong>QR code</strong>. Simply enable the <strong>Barcode </strong>option
                                        by clicking on it, and then click on the <strong>Save</strong> button located at
                                        the bottom right to apply the changes.<br/><br/>&nbsp;Now, Go to the <strong>Certificate</strong>
                                        tab and select "<strong>Generate ID Card</strong>." Now select<strong>
                                            Class</strong>, <strong>Section,</strong> and <strong>ID Card
                                            Template</strong>, and click on the
                                        <strong>Search </strong>button.<br/><br/><img
                                                src="../assets/article-media/student%20barcode%201st%20ss.png" alt=""
                                                width="1366" height="674"/><br/><br/></p>
                                    <p><strong>Student List</strong> will be open in below, now check the <strong>Checkbox</strong>
                                        next to the student name whom you want to generate the id card then Click on
                                        <strong>Generate </strong>button.<br/><br/><br/>Student id card will be
                                        generated successfully and this student id card you can also see the <strong>barcode</strong>
                                        , which is showing in below.<br/><br/><img
                                                src="../assets/article-media/BARCODE%20222.png" alt="" width="1330"
                                                height="657"/><br/><br/></p>
                                    <p>Now, to see<strong> barcode</strong> in student profile, you just need to go to
                                        the <strong>Student Information</strong> &gt; <strong>student Details</strong>
                                        and Select<strong> Class</strong>, <strong>Section</strong> or <strong>search by
                                            keyword and </strong>click on search button.<br/><br/><img
                                                src="../assets/article-media/barcode%203rd%20ss.png" alt="" width="1366"
                                                height="674"/><br/><br/>Student list will be open in below, now open the
                                        student profile, by click on <strong>view </strong>icon or student
                                        name.<br/><br/><img src="../assets/article-media/barcode%204th%20ss.png" alt=""
                                                            width="1366" height="681"/><br/><br/>Here, you can see
                                        the<strong> Barcode</strong>&nbsp;generated in the student
                                        profile.<br/><br/><img src="../assets/article-media/barcode%205th%20ss.png"
                                                               alt="" width="1366" height="789"/><br/><br/><br/></p>
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-barcode-in-student-id-card-and-his-profile by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:40:43 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
