...
<head><title>How to add Book? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Eduflow add book "/>
    <meta name="description" content="How to add Book?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Book?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Fri, 16 Oct, 2020</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a
                                        href="../category/library.php">Library</a></div>
                                <hr/>
                                <article class="article-body">To add book in Book List, go to <strong>Library &gt; Book
                                    List</strong> then click on <strong>Add Book</strong> button present at top right
                                    corner of the book list page. Here enter the <strong>Book Title, Book Number, ISBN
                                        Number, Publisher, Author, Subject, Rack Number, Qty, Book Price, Post
                                        Date</strong> and <strong>Description</strong> then click on
                                    <strong>Save</strong> button. You can view this added records in Book List page.
                                    <br/><br/><img src="../assets/article-media/library-addbook.png"
                                                   alt="Add book image" width="1000" height="450"/><br/><br/>To edit
                                    book click on the<strong> Edit</strong> icon present in the book list and to delete
                                    the book click on the <strong>Delete</strong> icon present in the book
                                    list.<br/><br/>
                                    <p>&nbsp;Here you can also add multiple books at the same time for this, you have to
                                        create a CSV file format. You can also download the sample file from top right
                                        corner by clicking on <strong>Download Sample Import File </strong>button and
                                        can change your file format accordingly. Then you have to select this CSV file
                                        on <strong>Select CSV File </strong>option and then click on the <strong>Import
                                            Book </strong>button.<br/><br/><img
                                                src="../assets/article-media/library-add-importbook.png"
                                                alt="Add import book image" width="1000" height="394"/></p></article>
                            ...
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="how-to-check-book-issue-report.html">How to check Book Issue
                                        Report?</a></li>
                                    <li><a href="how-to-check-book-due-report.html">How to check Book Due Report?</a>
                                    </li>
                                    <li><a href="how-to-check-book-inventory-report.html">How to check Book Inventory
                                        Report?</a></li>
                                    <li><a href="how-to-check-book-issue-return-report.html">How to check Book Issue
                                        Return Report?</a></li>
                                    <li><a href="how-student-can-view-book-list.php">How student can view Book list?</a>
                                    </li>
                                    <li><a href="how-student-can-view-issued-book-list.php">How student can view Issued
                                        Book list?</a></li>
                                </ul>
...
<!-- Mirrored from smart-school.in/article/how-to-add-book by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:32:42 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
