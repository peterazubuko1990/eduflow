...
<head><title>How to add Gallery? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add gallery in Eduflow"/>
    <meta name="description" content="How to add Gallery?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Gallery?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Mon, 14 Dec, 2020</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    CMS</a></div>
                                <hr/>
                                <article class="article-body">To add gallery, go to <strong>Front CMS &gt;
                                    Gallery</strong> click on<strong> Add</strong> button present at top right corner in
                                    the gallery list page, at click of this button <strong>Add Gallery</strong> page
                                    will be open.<br/>Here enter gallery <strong>Title, Description, Add Media, Gallery
                                        Images, SEO Details</strong>-(<strong>Meta Title, Meta Keyword, Meta
                                        Description)</strong> and select <strong>Sidebar Setting</strong> to show/hide
                                    sidebar and select <strong>Featured Image</strong> (you can delete feature image
                                    click on <strong>Delete</strong> button) and then click on <strong>Save</strong>
                                    button.<br/><br/><img src="../assets/article-media/frontcms-add-gallery.png"
                                                          alt="Add gallery image" width="1347" height="1000"/><br/><br/>Here
                                    you can view this added record in the <strong>Gallery List</strong>
                                    page.<br/><br/><img src="../assets/article-media/frontcms-list-gallery.png"
                                                        alt="gallery list image" width="1363" height="527"/><br/><br/>To
                                    edit gallery click on <strong>Edit</strong> icon and to delete gallery click on
                                    <strong>Delete</strong> icon present in the gallery list.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-gallery by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:37:43 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
