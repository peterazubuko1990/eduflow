<!doctype html>
<html lang="en">
<!-- Mirrored from smart-school.in/article/about-qr-code-attendance by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:31:11 GMT -->
<!-- Added by HTTrack -->
<meta http-equiv="content-type" content="text/html;charset=UTF-8"/><!-- /Added by HTTrack -->
<head><title>About QR Code Attendance - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="About QR Code Attendance"/>
    <meta name="description" content="About QR Code Attendance"/>
...
<?php include 'navbar.php'; ?><div class="wrapper">
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">About QR Code Attendance</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        ...
                                        href="../category/qr-code-attendance.php">QR Code Attendance</a></div>
                                <hr/>
                                <article class="article-body"><p><strong>About QR Code / Barcode Attendance</strong></p>
                                    <p><strong>QR Code / Barcode Attendance : </strong>To each <strong>Student</strong>
                                        and <strong>Staff</strong> assigned a unique QR code / Barcode that represents
                                        their identity. These QR Code / Barcode can be generated from the certificate
                                        module of our Eduflow and these code usually contains information about the
                                        individual, such as a unique identifier.</p>
                                    <ul style="list-style-type: square;">
                                        <li>QR code / Barcode are seamlessly integrated into the student and staff ID
                                            cards additionally, individuals can conveniently access their QR codes /
                                            Barcodes through their dedicated student and staff profiles.
                                        </li>
                                        <li>To mark attendance, an organizer or instructor uses a QR code scanner.</li>
                                        <li>Student and Staff present their QR Code / Barcode to be scanned upon
                                            entry.
                                        </li>
                                        <li>The scanner reads the code, and attendance data is recorded in the system.
                                        </li>
                                        <li>Attendance records are updated in real-time, providing accurate and timely
                                            information.
                                        </li>
                                        <li>This data accessed by administrators for tracking and reporting purposes.
                                        </li>
                                        <li>Administrators gain seamless access to this data, empowering them for
                                            comprehensive tracking and insightful reporting.
                                        </li>
                                    </ul>
                                </article>
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li>
                                        <a href="how-to-enable-the-auto-attendance-and-mark-the-attendance-of-student-and-staff-using-qr-code-barcode.html">How
    ...
    <?php include 'navbar.php'; ?><!--<div class="chatbtn">-->
...
<!-- Mirrored from smart-school.in/article/about-qr-code-attendance by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:31:14 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
