...
<head><title>How to add observation in CBSE Examination? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add observation in CBSE
                                    Examination?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Examination</a></div>
                                <hr/>
                                <article class="article-body"><p>To add an observation, go to <strong>CBSE Examination
                                    &gt; Observation</strong>. Once you click on the observation, the observation list
                                    will open on the right.<br/><br/><img src="../assets/article-media/01c.png" alt=""
                                                                          width="1366" height="734"/><br/><br/></p>
                                    <p>The observation list will be displayed on the right side, and the
                                        <strong>Add</strong> button will be shown in the top right corner. Simply click
                                        on the <strong>Add</strong> button, and the <strong>Add Observation</strong>
                                        model will open.<br/><br/><img src="../assets/article-media/02c.png" alt=""
                                                                       width="1366" height="734"/><br/><br/></p>
                                    <p>Please enter the <strong>Name </strong>and<strong> Description </strong>of the
                                        <strong>Observation</strong>. Next, select the relevant parameter from the
                                        <strong>CBSE Examination &gt;</strong> <strong>Observation Parameter</strong>
                                        module that has been already added and set the maximum marks for that parameter.
                                        If you wish to add multiple parameters for the observation, simply click on the
                                        <strong>Add More</strong> button to open additional fields below.<br/><br/><img
                                                src="../assets/article-media/03c.png" alt="" width="1366" height="734"/><br/><br/>
                                    </p>
                                    <p>And if you want the delete some field, simply click on <strong>Red Cross</strong>
                                        icon showing at the right side, relevant field will be deleted
                                        successfully.<br/><br/></p>
                                    <p>After entering all the relevant details, simply click on the
                                        <strong>save</strong> button located in the bottom right corner, the details
                                        will be saved successfully and displayed in the observation list.<br/><br/><img
                                                src="../assets/article-media/04c.png" alt="" width="1366" height="734"/><br/><br/>
                                    </p>
                                    <p>To <strong>edit</strong> the observation details, located at the action column on
                                        the right side. Simply click on the pencil icon corresponding to the desired
                                        observation, and the <strong>Edit Observation</strong> model will
                                        open.<br/><br/><img src="../assets/article-media/05c.png" alt="" width="1366"
                                                            height="734"/><br/><br/></p>
                                    <p>Now update all relevant details, then click on the <strong>save</strong> button,
                                        the details has been successfully saved on the <strong>Observation List</strong>.<br/><br/><img
                                                src="../assets/article-media/06c.png" alt="" width="1366" height="734"/><br/><br/>
                                    </p>
                                    <p>To delete the observation from the observation list, just click on
                                        <strong>Delete</strong> (cross) icon which is located in action column, delete
                                        confirmation model will be open.<br/><br/><img
                                                src="../assets/article-media/07c.png" alt="" width="1366" height="703"/><br/><br/>
                                    </p>
                                    <p>Now click on <strong>OK</strong> button, observation has been deleted
                                        successfully from the observation list.</p></article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-observation-in-cbse-examination by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:28:55 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
