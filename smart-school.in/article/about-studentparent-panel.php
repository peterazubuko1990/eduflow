<!doctype html>
<html lang="en">
<!-- Mirrored from smart-school.in/article/about-studentparent-panel by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:33:33 GMT -->
<!-- Added by HTTrack -->
<meta http-equiv="content-type" content="text/html;charset=UTF-8"/><!-- /Added by HTTrack -->
<head><title>About Student/Parent panel - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="aboutStudent/Parent panel in Eduflow"/>
    <meta name="description" content="AboutStudent/Parent panel"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">About Student/Parent panel</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Wed, 19 Jul, 2023</div>
                                </div>
                                ...
                                <hr/>
                                <article class="article-body"><strong>Student/Parent</strong> moudule is used to
                                    Student/Parent(Guardian) login.<br/>The Parent login is nothing but the login of the
                                    person whom we have made <strong>guardian</strong> at the time of student admission,
                                    so we can say it <strong>Guardian</strong> panel also. The Login credencial will
                                    generate for the guardian. the Student/Parent's module feature are same but only
                                    difference between these module is, <span style="background-color: #ffff00;">after login from parent panel you can see all the classes list of your all children and login from student panel You can only see the classes of the student whose account you have logged into</span>.<br/><br/>If
                                    student belongs to multiple classes then you need to choose your class (If you are
                                    login as Parent and you have more than one child then it will show you all the
                                    classes of all children) from the given modal, system will store your selected class
                                    as your default class (when you login next time it will process with this default
                                    class), Later on you can switch your class from the Class Switcher present at the
                                    top right corner.<br/><br/>By login to student/parent module they can check the
                                    details of the following sections -<br/><br/>
                                    <ul>
                                        <li>My Profile</li>
                                        <li>Fees</li>
                                        <li>Class Timetable</li>
                                        <li>Lesson Plan</li>
                                        <li>Syllabus Status</li>
                                        <li>Homework</li>
                                        <li>Online Exam</li>
                                        <li>Apply Leave</li>
                                        ...
                                        <li>Examination</li>
                                        <li>Notice Board</li>
                                        <li>Teacher's Review</li>
                                        <li>Library</li>
                                        <li>Transport Route</li>
                                        <li>Hostel Rooms</li>
                                    </ul>
                                    <img src="../assets/article-media/student-about-student-parent-panel.png"
                                         alt="about student/panelimage" width="1904" height="955"/></article>
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="how-student-can-view-homework-list-1.php">How student can view
                                        homework list?</a></li>
                                    ...
                                    <li><a href="how-student-can-check-exam-schedule-1.php">How Student can check Exam
                                        Schedule?</a></li>
                                    <li><a href="how-student-can-check-exam-result.php">How student can check Exam
                                        Result?</a></li>
...
<!-- Mirrored from smart-school.in/article/about-studentparent-panel by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:33:34 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
