...
<head><title>How to add Print Header Footer? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add print header footer in Eduflow"/>
    <meta name="description" content="How to add Print Header Footer?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Print Header Footer?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a href="../category/system-settings.php">System
                                    Settings</a></div>
                                <hr/>
                                <article class="article-body">To add print header footer, go to <strong>System Settings
                                    &gt; Print Header Footer</strong> then click on <strong>Fees Receipt</strong> (for
                                    students) present at top right corner in the print header footer page. Here you can
                                    replace your header image select <strong>Header Image</strong> and enter <strong>Footer
                                        Content</strong> and then click on <strong>Save</strong> button.<br/><br/><img
                                            src="../assets/article-media/fees.png" alt="" width="800"
                                            height="390"/><br/><br/>To remove header image click on
                                    <strong>Remove</strong> button present in header image in right corner of the page
                                    on mouseover.<br/><br/>To add print header footer payslip (for staff) click on
                                    <strong>Payslip</strong> present at top right corner in the print header footer
                                    page. Here you can replace your header image select <strong>Header Image</strong>
                                    and enter <strong>Footer Content</strong> and then click on<strong> Save</strong>
                                    button.<br/><br/><img src="../assets/article-media/payslip.png" alt="" width="800"
                                                          height="390"/><br/><br/>To remove header image click on
                                    <strong>Remove</strong> button present in header image in right corner of the page
                                    on mouseover.<br/><br/>To add print header footer <strong>Online Admission
                                        Receipt </strong>(for student) click on <strong>Online Admission
                                        Receipt </strong>present at top right corner in the print header footer page.
                                    Here you can replace your header image select <strong>Header Image</strong> and
                                    enter <strong>Footer Content</strong> and then click on<strong> Save</strong>
                                    button.<br/><br/><img src="../assets/article-media/onlineaddmission2.png" alt=""
                                                          width="800" height="385"/><br/><br/>To remove header image
                                    click on <strong>Remove</strong> button present in header image in right corner of
                                    the page on mouseover.
                                </article>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3">
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    <li><a href="about-system-settings.php">About System Settings</a></li>
                                    <li><a href="how-to-manage-general-setting.html">How to manage General Setting?</a>
                                    </li>
                                    <li><a href="how-to-manage-session-setting.html">How to manage Session Setting?</a>
                                    </li>
                                    <li><a href="how-to-manage-notification-setting.html">How to manage Notification
                                        Setting?</a></li>
                                    <li><a href="how-to-manage-sms-setting.html">How to manage SMS Setting?</a></li>
                                    ...
                                    <li><a href="how-to-enabledisable-users.html">How to enable/disable Users?</a></li>
                                    <li><a href="how-to-manage-modules.html">How to manage Modules?</a></li>
                                    <li><a href="how-to-add-custom-field.php">How to add Custom Field?</a></li>
...
<!-- Mirrored from smart-school.in/article/how-to-add-print-header-footer by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:35:14 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
