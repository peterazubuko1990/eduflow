...
<head><title>How to add Item Stock? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Eduflow add item stock"/>
    <meta name="description" content="How to add Item Stock?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Item Stock?</h3>
                                ...
                                <hr/>
                                <article class="article-body">To add item stock, go to<strong> Inventory &gt; Add Item
                                    Stock</strong>, here select the <strong>Item Category, Item, Supplier,
                                    Store</strong> and enter <strong>Qunatity, Purchase Price, Date, Attach
                                    Document</strong> and <strong>Description</strong> and then click on
                                    <strong>Save</strong> button. You can view this added record in Item stock list on
                                    the right side of the page.<br/><br/><img
                                            src="../assets/article-media/inventory-add-itemstock.png"
                                            alt="Add item stock image" width="1127" height="539"/><br/><br/>To edit item
                                    stock click on the <strong>Edit</strong> icon present in the item stock list and to
                                    delete item stock click on the <strong>Delete</strong> icon present in the item
                                    stock list.
                                </article>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3">
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    <li><a href="about-inventory.php">About Inventory</a></li>
...
<!-- Mirrored from smart-school.in/article/how-to-add-item-stock by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:40:53 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
