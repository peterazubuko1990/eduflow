...
<head><title>How to add student Certificate? - eduflow: School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="add student certificate, view certificate in Eduflow"/>
    <meta name="description" content="How to add student Certificate?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add student Certificate?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Sat, 08 Apr, 2023</div>
                                </div>
                                ...
                                <hr/>
                                <article class="article-body">To add student certificate, go to <strong>Certificate &gt;
                                    Student Certificate</strong> then enter <strong>Certificate Name</strong>
                                    (certificate name is only for certificate design reference purpose it will not be
                                    print on actual certificate)<strong>, Header Left Text, Header Center text, Header
                                        Right Text, Body Text</strong> (enter specified keywords for replacing student
                                    data dynamically at time of certificate generation)<strong>, Footer Left Text,
                                        Footer Center Text, Footer Right Text, Certificate Design &ndash; Header Height,
                                        Footer Height, Body Height, Body Width, Student Photo, Background Image</strong>
                                    and then click on <strong>Save</strong> button. You can view this added record in
                                    the <strong>Student Certificate List</strong> on the right side of the
                                    page.<br/><br/><img src="../assets/article-media/certificate1.png" alt=""
                                                        width="1366" height="669"/><br/><br/><br/>To edit student
                                    certificate, click on <strong>Edit</strong> icon and to delete student certificate,
                                    click on <strong>Delete</strong> icon present in <strong>Action</strong> column in
                                    student certificate list.<br/><br/>To preview student certificate, click on <strong>View</strong>
                                    icon present in <strong>Action</strong> column, at click of this icon <strong>Certificate</strong>
                                    will be open.<br/><br/><img src="../assets/article-media/previewcert.png" alt=""
                                                                width="800"
                                                                height="390"/><br/><br/><strong>Note:</strong> In
                                    certificate design we will suggest you to try to edit certificate design parameters
                                    by edit as many time possible until you will get your perfect design. You have to
                                    adjust many time design parameters to get your perfect design. While adjusting
                                    design parameters take browser final print preview or print as pdf option from
                                    browser as final reference of print design by using <strong>Generate
                                        Certificate</strong> link. Otherwise in final print you will get little bit
                                    deviation in design.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-student-certificate by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:32:03 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
