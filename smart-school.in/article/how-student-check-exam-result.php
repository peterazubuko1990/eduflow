...
<head><title>How student check Exam Result? - eduflow: School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="student check exam result in Eduflow"/>
    <meta name="description" content="How student check Exam Result?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How student check Exam Result?</h3>
                                ...
                                <article class="article-body">After login from student panel, go to sidebar menu and
                                    follow <strong>Examination &gt; Exam Result</strong>. Here you can see student
                                    result.<br/><br/><img
                                            src="../assets/article-media/examination-student-examresult.png"
                                            alt="student-exam result image" width="1350" height="662"/></article>
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="how-student-can-check-exam-schedule.php">How student can check Exam
                                        Schedule?</a></li>
                                </ul>
...
<!-- Mirrored from smart-school.in/article/how-student-check-exam-result by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:37:35 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
