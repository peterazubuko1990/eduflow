...
<head><title>How to add the assign observation in CBSE Examination? - Eduflow : School Management System by
    Eduflow</title>
    <meta charset="utf-8">
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add the assign observation in
                                    CBSE Examination?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Examination</a></div>
                                <hr/>
                                <article class="article-body"><p>To assign observation, go to <strong>CBSE Examination
                                    &gt; Assign Observation</strong>. Once clicked on the assign observation, assign
                                    observation list will be open on the right side.<br/><br/><img
                                            src="../assets/article-media/01z.png" alt="" width="1366"
                                            height="734"/><br/><br/></p>
                                    <p>Now at the top right corner <strong>Add</strong> button showing, simply click on
                                        add button <strong>Add Observation Term</strong> model will be
                                        open.<br/><br/><img src="../assets/article-media/02z.png" alt="" width="1366"
                                                            height="734"/><br/><br/></p>
                                    <p>Now, click on the <strong>Observation</strong>, a drop-down menu will appear,
                                        allowing you to select the desired observation that you have already saved in
                                        the observation module. Additionally, click on the <strong>Term</strong>. The
                                        term drop-down menu will open, and you can select the term that you have already
                                        saved in the term module. Fill description and click on the
                                        <strong>Save</strong> button, the details has been saved successfully in the
                                        <strong>Assigned Observation List.<br/><br/><img
                                                src="../assets/article-media/03z.png" alt="" width="1366" height="734"/><br/><br/></strong>
                                    </p>
                                    <p>In assign observation list, you can see the details of <strong>Observation, Term,
                                        Code, Description</strong> column which you recently added.Now assign marks to
                                        the specific observation, simply you need to go to the action column, where in
                                        first icon for the <strong>Assign Marks</strong>.</p>
                                    <p>To assign marks to a specific observation, simply go to the action column and
                                        click on the first icon for assigning marks.<br/><br/><img
                                                src="../assets/article-media/04z.png" alt="" width="1366" height="734"/><br/><br/>
                                    </p>
                                    <p>Just click on that icon, <strong>Assign Marks</strong> model will be
                                        open.<br/><br/><img src="../assets/article-media/05z.png" alt="" width="1366"
                                                            height="734"/><br/><br/></p>
                                    <p>In this model, you only need to select the class and section for which you want
                                        to assign marks to parameters. Once you have selected the class and section,
                                        click on the search button to open the student list for that class, along with
                                        their details.<br/><br/><img src="../assets/article-media/06z.png" alt=""
                                                                     width="1366" height="734"/></p>
                                    <p>Here, you can view the details of multiple students along with the parameter
                                        columns. To enter their marks, simply input the marks in the corresponding
                                        parameter column and click on the <strong>save</strong> button. This will
                                        successfully save the marks, and you can view them in the marksheet.<br/><br/>To
                                        <strong>edit</strong> assign observation list, go to the action column, here you
                                        can see the one pencil icon, simply click on <strong>pencil</strong> icon,
                                        <strong>edit observation term</strong> model will be open.<br/><br/><img
                                                src="../assets/article-media/07z.png" alt="" width="1366" height="734"/><br/><br/>
                                    </p>
                                    <p>Now update the details of observation term then click on <strong>save</strong>
                                        button, your update has been successfully <strong>save</strong> in <strong>Assign
                                            Observation List.<br/><br/><img src="../assets/article-media/08z.png" alt=""
                                                                            width="1366"
                                                                            height="734"/><br/><br/></strong></p>
                                    <p>To <strong>Delete</strong> the assign observation from the list, you need to go
                                        in action column, here you can see delete icon, simply click,
                                        <strong>delete</strong> confirmation model will be open.<br/><br/><img
                                                src="../assets/article-media/09z.png" alt="" width="1366" height="707"/><br/><br/>
                                    </p>
                                    <p>Now click on <strong>OK</strong> button, assign observation from the list
                                        successfully deleted.</p></article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-the-assign-observation-in-cbse-examination by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:35:41 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
