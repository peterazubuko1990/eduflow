...
<head><title>How to add pages? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add page in Eduflow"/>
    <meta name="description" content="How to add pages?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add pages?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Tue, 22 Dec, 2020</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    CMS</a></div>
                                <hr/>
                                <article class="article-body">To add pages, go to <strong>Front CMS &gt; Pages</strong>
                                    then click on <strong>Add</strong> button present at top right corner in page list
                                    page, then enter the page <strong>Title,</strong> select <strong>Page Type</strong>
                                    (Standard, Events (page to show all Events), News (page to show all News/Notices)
                                    and Gallery (page to show all images/video Galleries)) and <strong>Description, Add
                                        Media, SEO Detail</strong> click on <strong>Add (+)</strong> icon enter details
                                    here <strong>Meta Title, Meta Keyword, Meta Description</strong> and then select
                                    <strong>Sidebar Setting</strong> to show and hide sidebar and select <strong>Featured
                                        Image</strong> (featured image will be show only those themes or pages which
                                    have support for featured image) and then click on <strong>Save</strong> button.
                                    <br/><br/><img src="../assets/article-media/frontcms-add-page.png"
                                                   alt="Add page image" width="1366" height="1011"/><br/><br/>&nbsp;You
                                    can view this added record in the <strong>Page List</strong> page (Here you can see
                                    four by default page <strong>Home, Complain, Contact and 404
                                        page</strong>).<br/><br/><img
                                            src="../assets/article-media/frontcms-list-page.png" alt="page list image"
                                            width="1348" height="998"/><br/><br/>To edit page click on
                                    <strong>Edit</strong> icon and to delete page click on<strong> Delete</strong> icon
                                    present in the page list.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-pages by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:30:00 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
