...
<head><title>How to add course in the cart from the front site? - Eduflow : School Management System by
    Eduflow</title>
    <meta charset="utf-8">
    ...
    <meta name="keywords" content="add course in the cart from the front site"/>
    <meta name="description" content="How to add course in the cart from the front site?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add course in the cart from the
                                    front site?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Course</a></div>
                                <hr/>
                                <article class="article-body"><p>To <strong>add</strong> a course to your cart, go to
                                    the Eduflow Online Course front page, then click on <strong>Online
                                        Course</strong>.<br/><br/><img
                                            src="../assets/article-media/01%20online%20courses1.png" alt="" width="1366"
                                            height="681"/><br/><br/><br/></p>
                                    <p>Here you can view the multiple courses, and in some courses, there is an
                                        "<strong>add to cart</strong>" option available below. Some courses are free; in
                                        those courses, the "add to cart" option is not available, but you can still
                                        access them for free. Now, click <strong>Add To Cart</strong>, and the course
                                        will be added to the bucket at the top right, as well as the count of your
                                        course that you added to the cart, which is displayed on the
                                        bucket.&nbsp;<br/><br/><img src="../assets/article-media/02%20free%20course.png"
                                                                    alt="" width="1366" height="681"/><br/><br/></p>
                                    <p>Now in this cart you can see added course and its price as well as you can see
                                        sum of total amount of all the courses which you added in the
                                        cart.<br/><br/><img src="../assets/article-media/04%20Go%20to%20card04.png"
                                                            alt="" width="1366" height="681"/><br/><br/></p>
                                    <p>For buy course, click on <strong>Go To cart</strong> which is showing in below,
                                        cart list will be open, <br/><br/><img
                                                src="../assets/article-media/05%20proceed%20to%20checkout01.png" alt=""
                                                width="1366" height="681"/><br/><br/>here you can see the all details of
                                        the course as amount, discount, category and in left below you can see continue
                                        shopping option available, this option will redirect you the main page of online
                                        course and you can add the more course as well. Now click on <strong>proceed to
                                            checkout</strong> button which is showing in right, if you have not login
                                        online course, login module will be open then you need to login with your
                                        register email address and password then go to payment option and purchase the
                                        course.<br/><br/><br/><br/></p></article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-course-in-the-cart-from-the-front-site by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:38:33 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
