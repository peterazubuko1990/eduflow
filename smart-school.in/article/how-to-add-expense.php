...
<head><title>How to add Expense? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Eduflow add expense "/>
    <meta name="description" content="How to add Expense?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Expense?</h3>
                                ...
                                <hr/>
                                <article class="article-body">To add expense go to <strong>Expenses &gt; Add
                                    Expense</strong>, here select <strong>Expense Head</strong> and enter <strong>Name,
                                    Invoice Number, Date, Amount, Attach Document, Description</strong> and then click
                                    on the <strong>Save</strong> button. The saved record will appear on the right side
                                    in the Expense list.<br/><br/><img
                                            src="../assets/article-media/expense-add-expense.png.png"
                                            alt="Add expense image" width="1000" height="489"/><br/><br/>To edit expense
                                    click on the <strong>Edit</strong> icon present in the expense list and to delete
                                    expense click on the <strong>Delete</strong> icon present in the expense list.
                                </article>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3">
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    <li><a href="about-expense.php">About Expense</a></li>
...
<!-- Mirrored from smart-school.in/article/how-to-add-expense by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:33:21 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
