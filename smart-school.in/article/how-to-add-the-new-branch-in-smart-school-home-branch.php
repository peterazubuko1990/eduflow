...
<head><title>How to add the new branch in eduflowhome branch? - eduflow: School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Multi Branch"/>
    <meta name="description" content="Multi Branch"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add the new branch in eduflowhome
                                    branch?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Fri, 24 Mar, 2023</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a href="../category/multi-branch.php">Multi
                                    Branch</a></div>
                                <hr/>
                                <article class="article-body">To add a branch, login from the super admin panel, then go
                                    to <strong>Multi Branch &gt; Settings</strong> and click on the <strong>+ Add
                                        New</strong> button, the Add New Branch window will open. Enter the <strong>Envato
                                        Purchase Code</strong> now. You can make the current branch's login the default
                                    by checking the box. Now fill in the hostname, database name, username, and
                                    password, then finally click on the <strong>Verify &amp; Save</strong>&nbsp;button
                                    present at the bottom right corner.<br/><br/><strong>Note: </strong>(1) When you add
                                    the new branch in your <strong>Eduflow</strong>, database
                                    <strong>Username</strong> and <strong>Password</strong> must be same for the all
                                    branches including home branch database.<br/>(2) If any addons are installed in your
                                    <strong>other branches</strong> but they are not installed in your <strong>home
                                        branch</strong> then these addons will not be available in your <strong>home
                                        branch</strong> (with multi branch addon) while accessing other branches
                                    data.<br/><br/><img src="../assets/article-media/02%20add%20multibranch.png" alt=""
                                                        width="790" height="375"/><br/><br/>
                                    <p>Once a branch is created, you will see the details of the <strong>New Multi
                                        Branch</strong>.</p>
                                    <p><img src="../assets/article-media/03%20added%20mb.png" alt="" width="790"
                                            height="363"/><br/><br/><strong>Note:</strong> Please check your eduflowmain
                                        branch and sub branch, <strong>Base Url</strong> and <strong>File Upload
                                            Path</strong> are entered correctly in your <strong>General Settings &gt;
                                            File Upload Path</strong>. After saving general setting please once logout
                                        then relogin so changes will be come in effect.</p></article>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3">
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    <li><a href="about-multi-branch.php">About Multi Branch</a></li>
                                    <li><a href="how-to-switch-the-branch.html">How to switch the branch?</a></li>
                                    <li><a href="how-to-edit-a-branch.html">How to edit a branch?</a></li>
                                    <li><a href="how-to-delete-the-branch.html">How to delete the branch?</a></li>
                                </ul>
...
<!-- Mirrored from smart-school.in/article/how-to-add-the-new-branch-in-smart-school-home-branch by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:30:03 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
