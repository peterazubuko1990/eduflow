...
<head><title>Enabling SSL In Eduflow - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    ...
    <meta name="description" content="Enabling SSL In Eduflow"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">Enabling SSL In Eduflow</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Wed, 15 Apr, 2020</div>
                                </div>
                                ...
                                <hr/>
                                <article class="article-body">After installing ssl on your Eduflow hosting you need
                                    to edit your base url in following file -<br/><br/>Open file <strong><span
                                            style="color: #3598db;">\application\config\config.php</span></strong> and
                                    find the line <code><span style="color: #e74c3c;"><strong>$config['base_url'] = 'http://yourdomain.com/';</strong></span></code>
                                    change it to <code><span style="color: #27ae60;"><strong>$config['base_url'] = 'https://yourdomain.com/';</strong></span></code>
                                    thats it.
                                </article>
...
<!-- Mirrored from smart-school.in/article/enabling-ssl-in-smart-school by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:28:00 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
