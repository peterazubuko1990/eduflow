...
<head><title>How to add Postal Receive? - Smart School : School Management System by QDOCS</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="QDOCS">
    <meta name="keywords" content="Add postal receive in smart school"/>
    <meta name="description" content="How to add Postal Receive?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Postal Receive?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Fri, 13 Nov, 2020</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Office</a></div>
                                <hr/>
                                <article class="article-body">To add postal receive, go to <strong>Front Office &gt;
                                    Postal Receive</strong> then enter <strong>From Title, Reference No, Address, Note,
                                    To Title, Date</strong>&nbsp;and <strong>Attach Document</strong> and then click on
                                    the <strong>Save</strong> button. You can view this added record in the <strong>Postal
                                        Receive List</strong> on the right side of the page.<br/><br/><img
                                            src="../assets/article-media/frontoffice-add-postalrecieve.png"
                                            alt="Add postal receive image" width="1359" height="712"/><br/><br/>To view
                                    postal receive click on<strong> View</strong> icon present at
                                    <strong>Action</strong> column in the postal receive list, at click of this icon
                                    <strong>Details</strong> modal will be open. Here you can see the details of the
                                    postal receive.<br/><br/><img
                                            src="../assets/article-media/frontoffice-detail-postalrecieve.png"
                                            alt="Detail postal receive image" width="1362" height="398"/><br/><br/>To
                                    edit postal receive click on <strong>Edit</strong> icon and to delete postal receive
                                    click on <strong>Delete</strong> icon present in the postal receive list.
                                </article>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3">
                        <div class="ad_rsidebar">
                            <div class="sidebanners-ad"><a href="https://1.envato.market/smart_school_gmeet_live_class"
                                                           target="_blank"><img
                                    src="../assets/front/ads/google-meet.jpg" alt="Smart School"></a></div>
                        </div>
                        <div class="sidecard">
...
<!-- Mirrored from smart-school.in/article/how-to-add-postal-receive by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:40:28 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
