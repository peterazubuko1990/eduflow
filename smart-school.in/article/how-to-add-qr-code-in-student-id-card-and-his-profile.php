...
<head><title>How to add QR Code in student id card and his profile? - Eduflow : School Management System by
    Eduflow</title>
    <meta charset="utf-8">
    ...
    <meta name="keywords" content="Add QR Code in student id card and his profile."/>
    <meta name="description" content="Add QR Code in student id card and his profile."/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add QR Code in student id card
                                    and his profile?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Wed, 17 Jan, 2024</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a href="../category/certificate.php">Certificate</a>
                                </div>
                                <hr/>
                                <article class="article-body"><p>To add the <strong>QR code</strong> to the student id
                                    card and his profile, go to <strong>System Settings &gt; General Settings &gt;
                                        Miscellaneous.</strong> Here, you will find the second option that displays the
                                    <strong>ID Card Scan Code.<br/><br/><img src="../assets/article-media/SS11.png"
                                                                             alt="" width="1330"
                                                                             height="658"/><br/><br/></strong></p>
                                    <p>In the ID card scan code section, you will find two available options for scan
                                        type: the first is <strong>Barcode</strong>, and the second option is <strong>QR
                                            code</strong>. Simply enable the <strong>QR code</strong> option by clicking
                                        on it, and then click on the <strong>Save</strong> button located at the bottom
                                        right to apply the changes.<br/><br/></p>
                                    <p>Now, Go to the&nbsp;<strong>Certificate</strong>&nbsp;tab and select "<strong>Generate
                                        ID Card</strong>." Now
                                        select<strong>&nbsp;Class</strong>,&nbsp;<strong>Section,</strong>&nbsp;and&nbsp;<strong>ID
                                            Card Template</strong>, and click on the&nbsp;<strong>Search&nbsp;</strong>button.<br/><br/><img
                                                src="../assets/article-media/SS2.png" alt="" width="1330" height="657"/><br/><br/>
                                    </p>
                                    <p><strong>Student List</strong>&nbsp;will be open in below, now check
                                        the&nbsp;<strong>Checkbox</strong>&nbsp;next to the student name whose you want
                                        to generate the id card then Click on&nbsp;<strong>Generate&nbsp;</strong>button<strong>.&nbsp;<br/><br/><img
                                                src="../assets/article-media/SS3.png" alt="" width="1330" height="659"/><br/><br/></strong>
                                    </p>
                                    <p>Student ID card will be generated successfully and on this student ID card you
                                        can also see the <strong>QRcode</strong>, which is showing in
                                        below.<br/><br/><img src="../assets/article-media/SS4.png" alt="" width="1330"
                                                             height="659"/><br/><br/></p>
                                    <p>Now, to see<strong>&nbsp;QRcode</strong>&nbsp;in student profile just you need to
                                        go to the&nbsp;<strong>Student Information</strong>&nbsp;&gt;&nbsp;<strong>student
                                            Details</strong>&nbsp;and Select<strong>&nbsp;Class</strong>,&nbsp;<strong>Section</strong>&nbsp;or&nbsp;<strong>search
                                            by keyword and&nbsp;</strong>click on <strong>Search</strong> button.</p>
                                    <p><strong><img src="../assets/article-media/SS5.png" alt="" width="1330"
                                                    height="664"/><br/><br/></strong></p>
                                    <p>Student list will be open in below, now open the student profile, by click on&nbsp;<strong>View&nbsp;</strong>icon
                                        or student name.<br/><br/><img src="../assets/article-media/SS6.png" alt=""
                                                                       width="1330" height="659"/><br/><br/></p>
                                    <p>Now you can see the&nbsp;<strong>Student QR Code</strong>&nbsp;is&nbsp;<strong>generated</strong>.<br/><br/><img
                                            src="../assets/article-media/SS7.png" alt="" width="1330"
                                            height="657"/><br/><br/><br/></p>
                                    <p><strong>&nbsp;</strong></p>
                                    <p><strong><br/><br/></strong></p></article>
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="how-to-add-student-id-card.php">How to add student ID card?</a></li>
                                    <li><a href="how-to-generate-id-card.html">How to generate ID card?</a></li>
                                    <li>
                                        <a href="how-to-create-staffadmin-id-card-and-show-barcode-and-qr-code-on-id.html">How
                                            to create staff/admin id card and show Barcode and QR Code on id?</a></li>
                                </ul>
...
<!-- Mirrored from smart-school.in/article/how-to-add-qr-code-in-student-id-card-and-his-profile by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:40:26 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
