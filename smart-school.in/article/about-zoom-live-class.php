...
<head><title>About zoom live class - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="About zoom live class"/>
    <meta name="description" content="About zoom live class"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">About zoom live class</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Mon, 04 Dec, 2023</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a
                                        href="../category/zoom-live-classes.php">Zoom Live Classes</a></div>
                                <hr/>
                                <article class="article-body"><p>The Zoom Live Class module utilizes the <a
                                        href="https://marketplace.zoom.us/">https://marketplace.zoom.us/</a> meetings
                                    service to create live classes for students and live meetings for staff members. In
                                    this module, teachers or authorized persons can create live classes for students
                                    based on the timetable period, and further, students can join these classes from the
                                    student panel. Any authorized staff can create staff meetings, and concerning staff
                                    can join these meetings. To use this module, users must have the Zoom app installed
                                    on their devices. In Eduflow, the Zoom Live Class module only creates Classes
                                    and Meetings using the Zoom API, and users can start or join these classes or
                                    meetings. All processing and management are done by <a
                                            href="https://marketplace.zoom.us/">https://marketplace.zoom.us/</a> If you
                                    are using a Zoom paid account (like a 10 host license), then you should create
                                    individual host user Zoom API credentials and add them to Eduflow's Zoom Live
                                    Class in the 'Add Credential' option present in the teacher account. Since Zoom
                                    doesn't provide the ability to start multiple Live Classes simultaneously for a
                                    single host, even if you are using a Zoom paid account, you should create multiple
                                    host accounts in Zoom to run multiple simultaneous Live Classes, each started by a
                                    separate host.</p>
                                    <p>&nbsp;</p>
                                    <p><strong>Zoom Live Class Module Workflow</strong>: First, we will add Zoom account
                                        API credentials on the settings page and set the zoom API. Next, we will create
                                        a Zoom Live Class or meeting, and then we can start the live class or meeting.
                                        Students can join the live class, and staff members can join the meeting.
                                        Furthermore, we can check the join report for the live class or meeting</p>
                                    <p><strong><span style="color: #e74c3c;">Note: Zoom Live Class is Eduflow addon so to use it you should purchase separately and install it in your Eduflow.</span><br/><br/><img
                                            src="../assets/article-media/T45.png" alt="" width="1920"
                                            height="955"/><br/><br/></strong></p></article>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3">
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    <li><a href="how-to-configure-zoom-live-class.html">How to configure zoom live
                                        class?</a></li>
                                    <li><a href="how-to-create-zoom-live-classes.html">How to create zoom live
                                        classes?</a></li>
                                    <li><a href="how-to-join-zoom-live-classes-from-student-parent-side.html">How to
                                        join zoom live classes from student / parent side?</a></li>
                                    <li><a href="how-to-create-zoom-live-meeting.html">How to create zoom live
                                        meeting?</a></li>
                                    <li><a href="how-to-join-zoom-live-meeting.html">How to join zoom live meeting?</a>
                                    </li>
                                    <li><a href="how-to-check-zoom-live-meeting-report.html">How to check zoom live
                                        meeting report?</a></li>
                                    <li><a href="how-to-check-zoom-live-classes-report.html">How to check zoom live
                                        classes report?</a></li>
                                </ul>
...
<!-- Mirrored from smart-school.in/article/about-zoom-live-class by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:30:45 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
