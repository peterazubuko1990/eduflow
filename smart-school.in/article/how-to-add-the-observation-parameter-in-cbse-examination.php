...
<head><title>How to add the observation parameter in CBSE Examination? - Eduflow : School Management System by
    Eduflow</title>
    <meta charset="utf-8">
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add the observation parameter in
                                    CBSE Examination?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Examination</a></div>
                                <hr/>
                                <article class="article-body"><p>To add the observation parameter, go to <strong>CBSE
                                    Examination &gt; Observation Parameter</strong>.<br/><br/><img
                                        src="../assets/article-media/01d.png" alt="" width="1366"
                                        height="734"/><br/><br/></p>
                                    <p>Now on the left side you can see the input field for add the parameter, simply
                                        fill the name of the parameter and click on <strong>save</strong> button,
                                        parameter name will be displayed on the right side.</p>
                                    <p>To <strong>edit</strong> the parameter name, just click on
                                        <strong>pencil</strong> icon showing at the action column and update the
                                        parameter name then click on <strong>save</strong> button, parameter name will
                                        be update successfully.<br/><br/><img src="../assets/article-media/02d.png"
                                                                              alt="" width="1366"
                                                                              height="734"/><br/><br/></p>
                                    <p>To delete the parameter, just click on <strong>cross</strong> icon showing at the
                                        action column, delete confirmation model will be open.<br/><br/><img
                                                src="../assets/article-media/03d.png" alt="" width="1366" height="712"/><br/><br/>Simply
                                        click on the <strong>OK</strong> button, parameter name will be deleted
                                        successfully.</p></article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-the-observation-parameter-in-cbse-examination by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:28:53 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
