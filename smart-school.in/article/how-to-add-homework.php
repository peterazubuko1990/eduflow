...
<head><title>How to add Homework? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Eduflow add homework"/>
    <meta name="description" content="How to add Homework?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Homework?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        ...
                                        href="../category/homework.php">Homework</a></div>
                                <hr/>
                                <article class="article-body">To add homework, go to <strong>Homework &gt; Add
                                    Homework</strong> then click on<strong> Add</strong> button present at right side in
                                    homework list page, at click of this button a model will open, here select the
                                    <strong>Class, Section, Subject Group, Subject</strong> and enter <strong>Homework
                                        Date, Submission Date </strong>and you can see there is a tab for<strong>
                                        maximum marks, Attach Document</strong> (if you want to attach any file) and
                                    <strong>Description</strong> and then click on <strong>Save</strong> button. You can
                                    view this added record in <strong>Homework List page</strong>.<br/><br/><img
                                            src="../assets/article-media/Add%20homework.png" alt="" width="1366"
                                            height="643"/><br/><br/>
                                    <p>Now, search the homework that you recently saved. Go to "<strong>Homework" &gt;
                                        "Add Homework</strong>," enter the <strong>class, section, subject
                                        group</strong>, and <strong>subject</strong>, and then click the
                                        "<strong>Save</strong>" button. The homework that you recently saved will show
                                        up in your <strong>Upcoming Homework</strong>. Now click on the "<strong>evaluation</strong>"
                                        icon, which is showing in the&nbsp;<strong>Action</strong> column.</p><br/><img
                                            src="../assets/article-media/05%20upcoming%20homeworkss.png" alt=""
                                            width="1366" height="674"/><br/>
                                    <p><br/>and the "<strong>evaluation homework</strong> model" will be open. You can
                                        see the maximum marks in the evaluation model that you set when you created this
                                        homework here.<br/><br/><img
                                                src="../assets/article-media/06%20evaluate%20homework%20marks.png"
                                                alt="" width="1366" height="674"/><br/><br/>If you do not fill in the
                                        <strong>Maximum Marks</strong> at the time of creating homework, in the <strong>Evaluation
                                            Homework</strong> modal, there will be a blank in place of the <strong>Maximum
                                            Marks</strong>.<br/><br/><img
                                                src="../assets/article-media/7th%20no%20marks.png" alt="" width="1366"
                                                height="674"/><br/><br/><br/></p>To edit homework click on the <strong>Edit</strong>
                                    icon showing in Action column.<br/><br/><img
                                            src="../assets/article-media/08%20edit%20homework.png" alt="" width="1366"
                                            height="674"/><br/><br/>edit model will be open here you can update the
                                    details of your homework and click on <strong>Save</strong> button, your update will
                                    be saved successfully.<br/><br/><img
                                            src="../assets/article-media/09%20edit%20window.png" alt="" width="1366"
                                            height="674"/><br/><br/>To delete the homework click on the
                                    <strong>Delete</strong> icon showing in the action column, <br/><br/><img
                                            src="../assets/article-media/10%20delete%20Homework.png" alt="" width="1366"
                                            height="644"/><br/><br/><strong>Delete confirmation</strong> model will be
                                    open now click on ok button your homework will delete successfully.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-homework by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:32:50 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
