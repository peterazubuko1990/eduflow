...
<head><title>How to add Complain? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add complain in Eduflow"/>
    <meta name="description" content="How to add Complain?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Complain?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Office</a></div>
                                <hr/>
                                <article class="article-body">To add complain, go to <strong>Front Office &gt;
                                    Complain</strong> then select <strong>Complain Type, Source, Complain By, Phone,
                                    Date, Description, Action Taken </strong>and <strong>Assigned, Note</strong> and
                                    <strong>Attach Document</strong> and then click on <strong>Save</strong> button. You
                                    can view this added complain in the <strong>Complain List</strong> on the right side
                                    of this page.<br/><br/><img
                                            src="../assets/article-media/frontoffice-add-complain.png"
                                            alt="Add complain image" width="1350" height="991"/><br/><br/>
                                    <p>To view complain click on <strong>View</strong> icon present at
                                        <strong>Action</strong> column in the complain list, at click of this
                                        icon<strong> Details</strong> modal will be open. Here you can see the details
                                        of the complain.<br/><br/><img
                                                src="../assets/article-media/frontoffice-detail-complain.png"
                                                alt="Detail complain image" width="1359" height="390"/></p><br/>To edit
                                    complain click on<strong> Edit</strong> icon and to delete complain click on
                                    <strong>Delete</strong> icon present in complain list.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-complain by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:40:29 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
