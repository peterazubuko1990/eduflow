...
<head><title>How to add Income? - eduflow: School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="eduflowadd income"/>
    <meta name="description" content="How to add Income"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Income?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a href="../category/income.php">Income</a>
                                </div>
                                <hr/>
                                <article class="article-body">To add income go to<strong> Income &gt; Add
                                    Income</strong>, here select<strong> Income Head </strong>and&nbsp;enter <strong>Name,
                                    ...
                                    in the Income list.<br/><br/><img
                                            src="../assets/article-media/income-add-income.png" alt="Add income image"
                                            width="1000" height="492"/><br/><br/><br/>To edit income click on the
                                    <strong>Edit</strong> icon present in the income list and to delete income click on
                                    the <strong>Delete</strong> icon present in the income list.
                                </article>
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="about-income.php">About Income</a></li>
...
<!-- Mirrored from smart-school.in/article/how-to-add-income by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:33:25 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
