...
<head><title>How to add Event? - Eduflow : School Management System by QDOCS</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="QDOCS">
    <meta name="keywords" content="Add event in Eduflow"/>
    <meta name="description" content="How to add Event?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Event?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    CMS</a></div>
                                <hr/>
                                <article class="article-body">To add event, go to <strong>Front CMS &gt; Event</strong>
                                    click on<strong> Add</strong> button present at top right corner in the event list
                                    page, then enter event <strong>Title, Venue, Event Start Date, Event End Date,
                                        Description, Add Media, SEO Details- Meta Title, Meta Keyword, Meta
                                        Description</strong> then select <strong>Sidebar Setting</strong> to show/ hide
                                    sidebar and select <strong>Featured Image</strong> (you can delete feature image
                                    click on Delete button) and then click on <strong>Save</strong>
                                    button.<br/><br/><img src="../assets/article-media/frontcms-add-event.png"
                                                          alt="Add Event image" width="1363" height="1024"/><br/><br/>Here
                                    you can view this added record in the <strong>Event List</strong>
                                    page.<br/><br/><img src="../assets/article-media/frontcms-list-event.png"
                                                        alt="Event list image" width="1365" height="530"/><br/><br/>To
                                    edit event click on <strong>Edit</strong> icon and to delete event click on <strong>Delete</strong>
                                    icon present in the event list.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-event by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:30:01 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
