...
<head><title>How to add the term in CBSE Examination? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add the term in CBSE
                                    Examination?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Examination</a></div>
                                <hr/>
                                <article class="article-body"><p><strong>About Term</strong></p>
                                    <p>In CBSE examinations, a term refers to a specific period of time during the
                                        academic year in which exams are conducted. For example academic year is divided
                                        into two terms - Term 1 and Term 2. The marks obtained in both terms are added
                                        together to determine the final result of the academic year. In this CBSE
                                        Examination you can add the multiple terms.<br/><br/></p>
                                    <p>To add a new <strong>Term</strong>, you first need to log in to the Eduflow
                                        super admin panel. Once you have logged in to Eduflow, click on <strong>CBSE
                                            Examination &gt; Term</strong>, which is displayed in the left sidebar.<br/><br/><img
                                                src="../assets/article-media/01I.png" alt="" width="1366" height="734"/><br/><br/>
                                    </p>
                                    <p>After clicking on <strong>Term</strong>, the <strong>Term List</strong> page will
                                        open on the right side. You will now see an <strong>Add</strong> button in the
                                        top right corner. Simply click on the <strong>Add</strong> button, and the
                                        <strong>Add Term</strong> model will open.<br/><br/><img
                                                src="../assets/article-media/02I.png" alt="" width="1366" height="734"/><br/><br/>
                                    </p>
                                    <p>Please enter the <strong>Name</strong>, <strong>Code</strong>, and <strong>Description</strong>
                                        of the term. Afterward, click the <strong>Save</strong> button. The new term
                                        will be successfully added, and you will be able to see it in the <strong>Term
                                            list</strong>.<br/><br/><br/></p>
                                    <p>To edit the term, go to <strong>CBSE Exam &gt; Term</strong>. The term list will
                                        be displayed. On the right side, you will see the action column. In this column,
                                        there is a pencil icon. Click on the pencil icon and the <strong>Edit
                                            Term</strong> model will open.<br/><br/><img
                                                src="../assets/article-media/03I.png" alt="" width="1366" height="734"/><br/><br/>
                                    </p>
                                    <p>now here you can edit the term name, code, description then click on
                                        <strong>save</strong> button, your update will be successfully save in the Term
                                        list.<br/><br/><img src="../assets/article-media/ddI.png" alt="" width="1366"
                                                            height="734"/><br/><br/><br/></p>
                                    <p>To delete the term, go to the <strong>CBSE Exam &gt; Term</strong>. The term list
                                        will be displayed. On the right side you will see the <strong>Action</strong>
                                        column, in this action column there is the delete icon showing, simply click on
                                        the <strong>Delete</strong> icon, <strong>Delete</strong> confirmation model
                                        will be open.<br/><br/><img src="../assets/article-media/04I.png" alt=""
                                                                    width="1366" height="709"/><br/><br/></p>
                                    <p>Now click on the <strong>OK</strong> button, the term will be deleted
                                        successfully from the term list.</p>
                                    <p><br/><br/><br/><br/><br/></p></article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-the-term-in-cbse-examination by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:28:50 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
