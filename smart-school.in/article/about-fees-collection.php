...
<head><title>About Fees Collection - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="About fees collection in Eduflow"/>
    <meta name="description" content="About Fees Collection"/>
...
<?php include 'navbar.php'; ?><!--End Navbar-->
<div class="wrapper">
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">About Fees Collection</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Fri, 27 Nov, 2020</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.html"><i class="fa fa-home"></i></a><a
                                        href="../articles.html">Articles</a><a href="../category/fees-collection.html">Fees
                                    Collection</a></div>
                                <hr/>
                                <article class="article-body">In Fees Collection module, you can effortlessly manage
                                    student Fees Collection and maintain fees related data. Fees Master is created
                                    session wise so you need to enter Fees Master data for every session. In this model,
                                    we collect the fees, adjust the fee discount and see the fees collected by the
                                    student from the payment id.<br/><br/><strong>Fees collection module
                                        workflow:- </strong>First we will configure the <strong>Fees Type, Fees Group,
                                        Fees Master</strong> and <strong>Fees Reminder</strong> and prepare our fees
                                    structure for the current session and then we will collect fees of the students then
                                    we will search fees payment and search due fees and check all reports and Students
                                    can also look for details of fees and can pay fees.<br/><br/>We will create fees
                                    structure in Eduflow by using, <strong>Fees Type</strong> (under fees type we
                                    collect different types of fees by the school like Admission Fees, Months wise Fees,
                                    Uniform Fees, Exam fees, Library Fees, Sports Fees, Transport Fees etc.). <strong>Fees
                                        Group</strong> (we use fee groups to create different types of groups.) You can
                                    then allocate / allocate this fee group to the entire class-section or a particular
                                    student. You can create a fee group as an instalment.<br/><br/><img
                                            src="../assets/article-media/feecollection-about.png"
                                            alt="Fees collection about image" width="1364" height="497"/></article>
    ...
    <?php include 'footer.php'; ?>    <section class="copy-right2">
        <div class="container">
       <!--<div class="chatbtn">-->
...
<!-- Mirrored from smart-school.in/article/about-fees-collection by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:29:31 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
