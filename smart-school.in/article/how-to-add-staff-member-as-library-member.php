...
<head><title>How to add staff member as Library Member? - Smart School : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Smart school add staff as library member"/>
    <meta name="description" content="How to add staff member as Library Member?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add staff member as Library
                                    Member?</h3>
                                ...
                                <hr/>
                                <article class="article-body">To add staff member as Library Member, go to <strong>Library
                                    &gt; Add Staff Member</strong> after that to search specific member enter the staff
                                    name and click on <strong>Search</strong> button then click on <strong>+</strong>
                                    button from the<strong> Action</strong> column, at click of this button it will open
                                    a modal, here enter L<strong>ibrary Card Number</strong> and then click to <strong>Add</strong>
                                    button.<br/><br/><img
                                            src="../assets/article-media/library-addstaff-add-member.png.png"
                                            alt="Add staff member image" width="1000" height="474"/><br/><br/>The added
                                    staff member will be shown in green color row in the staff member list. To remove
                                    staff membership click on the Surrender button present in Action
                                    column.<br/><br/><img src="../assets/article-media/library-add-staffmember.png.png"
                                                          alt="Add staff member image" width="1000" height="314"/>
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-staff-member-as-library-member by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:32:44 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
