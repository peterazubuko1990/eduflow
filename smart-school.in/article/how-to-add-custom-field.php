...
<head><title>How to add Custom Field? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add custom field in Eduflow"/>
    <meta name="description" content="How to add Custom Field?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Custom Field?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Settings</a></div>
                                <hr/>
                                <article class="article-body">To add custom field, go to <strong>System Setting &gt;
                                    Custom Field</strong> then select <strong>Field Belongs To, Field Type, Field Name,
                                    Grid</strong> <strong>(Bootstrap Column e.g. 6) - Max is 12, Field Values (Separate
                                    By Comma)</strong> and check <strong>Validation, Visibility</strong> and then click
                                    on <strong>Save</strong> button. You can view this added record in the <strong>Custom
                                        Field List</strong> on the right side of the page.<br/><br/><img
                                            src="../assets/article-media/systemsetting-add-customfield.png"
                                            alt="Add custom Field image" width="1358" height="629"/><br/><br/>To edit
                                    custom field click on <strong>Edit</strong> icon and to delete custom field click on
                                    <strong>Delete</strong> icon present in the custom field list.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-custom-field by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:35:20 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
