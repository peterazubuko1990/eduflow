...
<head><title>About Student Information - Eduflow : School Management System by QDOCS</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="QDOCS">
    <meta name="keywords" content="About student information in Eduflow"/>
    <meta name="description" content="About Student Information"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">About Student Information</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Thu, 12 Nov, 2020</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a
                                        href="../category/student-information.php">Student Information</a></div>
                                <hr/>
                                <article class="article-body">Student information module is a collection of data all the
                                    students. It is used for keep maintaining end to end details of students including
                                    student category, admission, sibling, bank details, parent/guardian details
                                    etc.<br/><br/><strong>Student information module workflow</strong>- First we will
                                    add <strong>Student Categories, Student House</strong> and then take <strong>Student
                                        Admission</strong> and then <strong>Online Admission, Student Details</strong>.
                                    If you want to add additional fields in student admission form then you can use
                                    <strong>Custom Fields feature</strong> for this go to <strong>System Settings &gt;
                                        Custom Fields</strong> and add your desired fields in Student. If you also don't
                                    want any default fields in student admission then you can disable it from <strong>System
                                        Settings &gt; System Fields</strong> and disable student system
                                    fields.&nbsp;<br/><br/><img
                                            src="../assets/article-media/studentinformation-about.png"
                                            alt="About student information image" width="1366" height="457"/></article>
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="how-to-check-student-history-report.html">How to check Student History
                                        report?</a></li>
                                    <li><a href="how-to-check-student-login-credential-report.html">How to check Student
                                        Login Credential report?</a></li>
                                    <li><a href="how-to-check-class-subject-report.html">How to check Class Subject
                                        Report?</a></li>
                                    <li><a href="how-to-check-admission-report.html">How to check Admission Report?</a>
                                    </li>
                                    <li><a href="how-to-check-sibling-report.html">How to check Sibling report?</a></li>
                                    <li><a href="how-to-check-student-profile-report.html">How to check Student Profile
                                        Report?</a></li>
                                    <li><a href="how-to-check-homework-evaluation-report-1.html">How to check Homework
                                        Evaluation Report?</a></li>
                                    <li><a href="how-to-check-student-gender-ratio-report.html">How to check Student
                                        Gender Ratio Report?</a></li>
                                    <li><a href="how-to-check-student-teacher-ratio-report.html">How to Check Student
                                        Teacher Ratio Report?</a></li>
                                </ul>
...
<!-- Mirrored from smart-school.in/article/about-student-information by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:29:16 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
