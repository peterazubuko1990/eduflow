...
<head><title>How to add Student House? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add student house in Eduflow"/>
    <meta name="description" content="How to add Student House?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Student House?</h3>
                                ...
                                <hr/>
                                <article class="article-body">To add student house, go to <strong>Student Information
                                    &gt; Student House</strong> then enter house<strong> Name</strong> and <strong>Description</strong>
                                    and then click on<strong> Save</strong> button. You can view this added record in
                                    the <strong>Student House</strong> <strong>List</strong> on right side of the page.
                                    <br/><br/><img src="../assets/article-media/studentinformation-add-studenthouse.png"
                                                   alt="Add student house image" width="1361" height="460"/><br/><br/>
                                    <p>To edit student house click on<strong>&nbsp;Edit</strong> icon and to delete
                                        student house click on<strong>&nbsp;Delete</strong> icon present in the student
                                        house list.</p></article>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3">
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    <li><a href="about-student-information.php">About Student Information</a></li>
                                    ...
                                    <li><a href="how-to-add-multi-class-student.php">How to add Multi Class Student?</a>
                                    </li>
...
<!-- Mirrored from smart-school.in/article/how-to-add-student-house by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:36:44 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
