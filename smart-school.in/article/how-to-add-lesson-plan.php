...
<head><title>How to add Lesson Plan? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add Lesson Plan"/>
    <meta name="description" content="How To Add Lesson Plan?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Lesson Plan?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Plan</a></div>
                                <hr/>
                                <article class="article-body"><p>To create Lesson Plan first you should prepare Class
                                    Timetable from <strong>Academics &gt; Class Timetable</strong>. Lesson Plan can be
                                    created teacher wise so once you created <strong>Class Timetable</strong> for the
                                    class so it will reflect in <strong>Manage Lesson Plan</strong>, select <strong>Teacher</strong>
                                    drop down.</p>
                                    <p>Now, go to <strong>Lesson Plan &gt; Manage Lesson plan</strong>, select <strong>Teacher</strong>
                                        for which you want to add <strong>Lesson Plan</strong> (here selected teacher's
                                        time table will show in&nbsp; ascending in the below of the page&nbsp; ). Here
                                        at any period + sign button will show to <strong>Add</strong> <strong>Lesson
                                            Plan</strong> window for a selected teacher. <br/><br/><img
                                                src="../assets/article-media/61/teacher-period-list.png"
                                                alt="teacher period list" width="1000" height="480"/><br/><br/>Click on
                                        + icon button to enter <strong>Lesson, Topic Sub Topic,</strong> (Date, Time
                                        From, Time To will be come automatically from period), <strong>Lecture YouTube
                                            URL </strong>(if you have lecture recorded video uploaded on YouTube),
                                        <strong>Lecture Video </strong>(if you have lecture recorded video file.
                                        Uploading video file size will be depend on your server max upload size, max
                                        post size and maximum execution time. By default in Eduflow 1 GB file size
                                        upload is set to be allowed)<strong>, Attachment </strong>(any teaching material
                                        which will be available for student download)<strong>, Teaching Methods, General
                                            Objectives, Previous Knowledge, Comprehensive Questions,
                                            Presentation</strong> (you can also add image in presentation from <strong>Add
                                            Image</strong> button present above the presentation field) details for
                                        <strong>Lesson Plan</strong> then finally click on <strong>Save</strong> button.<br/><br/><img
                                                src="../assets/article-media/61/add-lesson-plan.png"
                                                alt="add lesson plan" width="1000" height="537"/></p>
                                    <p>After adding <strong>Lesson plan</strong> two options will show to View details
                                        and Edit Lesson plan.</p>
                                    <p>After adding <strong>Lesson Plan</strong> it will be available for students to
                                        view <strong>Lesson Plan</strong> in student panel <strong>Lesson Plan</strong>
                                        page.<br/><br/><img src="../assets/article-media/61/lesson-plan-view.png"
                                                            alt="lesson plan view" width="1000" height="562"/></p>
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-lesson-plan by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:31:02 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
