...
<head><title>How to add Online Exam? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add Online exam in Eduflow"/>
    <meta name="description" content="How to add Online Exam?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Online Exam?</h3>
                                    <div class="font12 minus8"><i class="fa fa-clock-o"></i> Mon, 27 Feb, 2023</div>
                                </div>
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a
                                        href="../category/online-examinations.php">Online Examinations</a></div>
                                <hr/>
                                <article class="article-body">To add online exam, go to <strong>Online Examinations &gt;
                                    Online Exam.</strong><br/><br/><img
                                        src="../assets/article-media/01%20online%20examination.png" alt="" width="1366"
                                        height="674"/><br/><br/>then click on <strong>Add Exam</strong> button present
                                    at top right corner of the online exam list page, at click of this button <strong>Add
                                        Exam</strong> modal will be open.<br/><br/><img
                                            src="../assets/article-media/02%20add%20exam.png" alt="" width="1366"
                                            height="762"/><br/><br/>Here enter the <strong>Exam Title</strong>, <strong>Exam
                                        From</strong>, <strong>Exam To</strong>, Time Duration and select <strong>Attempt</strong>
                                    (its maximum attempt limit of particular student exam for every assigned student),
                                    <strong>Passing Percentage</strong>, <strong>Publish Exam</strong> (if the exam is
                                    published, it will appear in exam schedule list and also in the student panel) and
                                    <strong>Publish Result</strong> (if the exam result is published, it will appear in
                                    the result list and also result will appear in the student panel. This option will
                                    be disabled if exam type is Quiz ), <strong>Auto Result Publish Date</strong> ( if
                                    exam type is Quiz then this option will be disabled), <strong>Answer Word
                                        Limit</strong> (<strong>Set -1 for No Limit</strong>) : Suppose if you manage
                                    one online exam where 10 questions will be available with their 10 descriptive
                                    answers, so that all 10 descriptive answers have no limitation on their description,
                                    overall if you <strong>set -1</strong> for the answer word limit, you can manage the
                                    description in unlimited words. <strong>Negative Marking</strong> ( if this option
                                    is checked then negative mark will be show next to the question ), <strong>Display
                                        marks in Exam</strong> ( if this option is checked then question mark will be
                                    show next to the question ), <strong>Random Question</strong> ( if random question
                                    is checked then the question will show in different order in different students )
                                    and <strong>Description</strong> and then click on the <strong>Save</strong> button.
                                    You can view this added record in the Online Exam list page.<br/><br/><img
                                            src="../assets/article-media/03%20add%20exam%20data.png" alt="" width="1366"
                                            height="762"/><br/><br/>After click on <strong>Save</strong> button your
                                    question will be save in <strong>upcoming exam</strong> and if you want to see that
                                    question, simply go to the<strong><strong> online examination &gt; online exam.<br/></strong></strong>
                                    <p>In <strong>Upcoming Exams</strong>, you can see those exam, whose exam dates are
                                        currently available till the exam to set.</p><strong><br/></strong><strong><img
                                            src="../assets/article-media/06%20new%20upcoming%20exam.png" alt=""
                                            width="1366" height="674"/><br/></strong><br/>
                                    <p>In <strong>Closed Exams</strong>, you can see those exam list whose exam dates
                                        are passed till the exam to set.<br/><br/><img
                                                src="../assets/article-media/02%20online%20exam%20closed%20exam%20tab.png"
                                                alt="" width="1366" height="681"/><br/><br/></p>To edit question in exam
                                    click on the <strong>Edit</strong> icon showing in the action column and update the
                                    details.<br/><br/><img src="../assets/article-media/04%20edit%20exam.png" alt=""
                                                           width="1366" height="654"/><br/><br/>
                                    <p>In closed exam if you want to <strong>delete</strong> the exam from the exam list
                                        in <strong>bulk</strong>, just you need to check the <strong>checkbox</strong>
                                        of &ldquo;<strong>select all</strong>&rdquo; and click on<strong>
                                            Delete</strong> button which is showing in right middle than exam in bulk
                                        will be delete successfully.<br/><br/></p><img
                                            src="../assets/article-media/03%20bulk%20delete.png" alt="" width="1366"
                                            height="664"/></article>
                            ...
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="how-to-check-online-exam-result-report.html">How to check Online Exam
                                        Result Report?</a></li>
                                    <li><a href="how-to-check-online-exams-report.html">How to check Online Exams
                                        Report?</a></li>
                                    <li><a href="how-to-check-online-exams-attempt-report.html">How to check Online
                                        Exams Attempt Report?</a></li>
                                    <li><a href="how-to-check-online-exam-rank-report.html">How to check Online Exam
                                        Rank Report?</a></li>
                                    <li><a href="how-can-student-attempt-online-exam.php">How can student attempt online
                                        exam?</a></li>
                                </ul>
...
<!-- Mirrored from smart-school.in/article/how-to-add-online-exam by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:29:54 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
