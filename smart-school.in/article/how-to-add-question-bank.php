...
<head><title>How to add Question Bank? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content=" Add question in Eduflow"/>
    <meta name="description" content="How to add Question Bank?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Question Bank?</h3>
                                ...
                                <hr/>
                                <article class="article-body">To add question bank, go to <strong>Online Examinations
                                    &gt; Question Bank </strong>then click on <strong>Add Question</strong> button
                                    present at top right corner of the question bank page, at click of this button
                                    <strong>Question</strong> modal will be open.<br/><br/>Here select the <strong>Subject,</strong>&nbsp;<strong>Question
                                        Type</strong>, <strong>Question Level</strong>, <strong>Class</strong>,<strong>
                                        Section </strong>and <strong>Question</strong>&nbsp;then click on
                                    <strong>Save</strong> button. You can view this added record in <strong>Question
                                        Bank</strong> page.&nbsp;<br/><br/><img
                                            src="../assets/article-media/onlineex-addquestion-bank.png"
                                            alt="add question bank" width="1913" height="952"/><br/><br/><strong><span
                                            style="color: #c0392b;">Note</span> - </strong>Math type plugin is a paid
                                    plugin so to use it you should purchase its license from <span
                                            style="color: #3598db;"><a style="color: #3598db;"
                                                                       href="https://www.wiris.com/" target="_blank"
                                                                       rel="noopener">https://www.wiris.com/</a></span><br/>
                                    <p><br/>Here you can search any record by entering the<strong> class</strong>,
                                        <strong>section</strong>, <strong>subject</strong>, <strong>question</strong>
                                        <strong>type</strong>, and&nbsp;<strong>question level. </strong>The list of
                                        searched records will be shown below the page.</p><img
                                            src="../assets/article-media/01%20question%20bank.png" alt="" width="1366"
                                            height="789"/><br/><br/>To View question in detail, you can click on
                                    <strong>View</strong> icon which is showing in the Action column.<br/><br/><img
                                            src="../assets/article-media/04%20view%20questionss.png" alt="" width="1366"
                                            height="674"/><br/><br/>To edit question click on <strong>Edit</strong> icon
                                    and to delete question click on <strong>Delete</strong> icon present in the question
                                    bank page.<br/><br/>You can also delete more than one record at a time by using bulk
                                    delete feature. To delete bulk record click on the <strong>Bulk Delete</strong>
                                    button present at the top right corner in the page and confirmation model will be
                                    open then click on <strong>OK</strong> button so that question in bulk be delete
                                    successfully.<br/><br/><img src="../assets/article-media/07%20bulk%20delete.png"
                                                                alt="" width="1366" height="674"/></article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-question-bank by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:29:51 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
