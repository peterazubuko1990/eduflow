...
<head><title>How to add To Do List? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="add to do list in Eduflow"/>
    <meta name="description" content="How to add To Do List?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add To Do List?</h3>
                                ...
                                <hr/>
                                <article class="article-body">To add to do list, click on the <strong>Calendar</strong>
                                    icon present on the top right corner of the header, it will redirect you in the
                                    calendar page, here&nbsp; click on <strong>Add</strong> icon present at the right
                                    side of the page, then&nbsp;enter <strong>Title, Date</strong> and then click on
                                    <strong>Save</strong> button. Once record is added you can see it in the <strong>To
                                        Do List</strong>.<br/><br/><img
                                            src="../assets/article-media/calendar-add-todolist.png"
                                            alt="Add to do list image" width="1366" height="478"/><br/><br/>To edit to
                                    do list, click on <strong>Edit</strong> icon and to delete to do list, click on
                                    <strong>Delete</strong> icon present in the to do list.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-to-do-list by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:28:13 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
