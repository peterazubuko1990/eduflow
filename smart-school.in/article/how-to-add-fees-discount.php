...
<head><title>How to add Fees Discount? - eduflow: School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add fees discount in Eduflow"/>
    <meta name="description" content="How to add Fees Discount?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Fees Discount?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Collection</a></div>
                                <hr/>
                                <article class="article-body"><p>To add a fee discount, go to <strong>Fees
                                    Collection</strong> &gt; <strong>Fees Discount.</strong> Now fill in the discount
                                    <strong>name</strong>, <strong>discount code</strong>, <strong>discount
                                        type</strong> (<strong>percentage or fixed amount), </strong>and <strong>description,</strong>
                                    and click on the <strong>Save </strong>button. You can view this added record in the
                                    <strong>Fees Discount List</strong>. If the <strong>Discount type</strong> is a
                                    <strong>percentage</strong>, you can offer discounts of 10% or 20% etc.&nbsp; If the
                                    <strong>Discount type</strong> is "<strong>Fix Amount</strong>," we can apply a
                                    discount in fix amount.&nbsp;</p><img
                                        src="../assets/article-media/01%20fees%20discount.png" alt="" width="1366"
                                        height="674"/><br/><br/>
                                    <p>To assign / view students, click on the <strong>Assign / View</strong> Student
                                        icon, which is shown in the <strong>Action</strong> column in the fees discount
                                        list. By clicking on this icon, it will redirect you to the <strong>Assign
                                            Fees</strong> <strong>Discount</strong> page. Now select
                                        <strong>Class</strong>, <strong>Section</strong>, <strong>Category</strong>,
                                        <strong>Gender,</strong> and <strong>RTE,</strong> and then click on the
                                        <strong>search</strong> button. The student list will be displayed, and you can
                                        select the student to whom you want to assign the fee discount by checking the
                                        box, then click the Save button to assign the discount to the students.</p><img
                                            src="../assets/article-media/feescollection-feesdiscount-assignstudent.png"
                                            alt="Assign student fees discount image" width="1366"
                                            height="496"/><br/><br/>To edit fees discount click on <strong>Edit</strong>
                                    icon and to delete fees discount click on <strong>Delete</strong> icon present in
                                    the fees discount list.
                                </article>
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="how-to-add-collect-fees.php">How to add Collect Fees?</a></li>
...
<!-- Mirrored from smart-school.in/article/how-to-add-fees-discount by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:29:34 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
