...
<head><title>How to add Item? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Eduflow add item"/>
    <meta name="description" content="How to add Item?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Item?</h3>
                                ...
                                <hr/>
                                <article class="article-body">To add item, go to <strong>Inventory &gt; Add
                                    Item</strong>, here enter<strong> Item</strong> and select the <strong>Item
                                    Category, Unit</strong> and <strong>Description</strong> and then click on <strong>Save</strong>
                                    button. You can view this added record in the Item list on the right side of the
                                    page.<br/><br/><img src="../assets/article-media/inventory-add-item.png"
                                                        alt="Add item image" width="1252" height="425"/><br/><br/>To
                                    edit item click on the <strong>Edit</strong> icon present in the item list and to
                                    delete item click on the <strong>Delete</strong> icon present in item list.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-item by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:32:36 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
