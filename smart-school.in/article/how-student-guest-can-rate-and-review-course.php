...
<head><title>How Student / Guest can rate and review course? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Student / Guest can rate and review course"/>
    <meta name="description" content="How Student / Guest can rate and review course?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How Student / Guest can rate and review
                                    course?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                        href="../articles.php">Articles</a><a href="../category/online-course.php">Online
                                    Course</a></div>
                                <hr/>
                                <article class="article-body"><p>For ratings and review of online course, go to <strong>front
                                    page of Eduflow &gt; online course.<br/><br/><img
                                            src="../assets/article-media/01%20online%20course%20front%20page01.png"
                                            alt="" width="1366" height="681"/><br/><br/></strong></p>
                                    <p>Now click on <strong>Login</strong> button<strong>, login model</strong> will be
                                        open.<br/><br/><img src="../assets/article-media/02%20login%20window.png" alt=""
                                                            width="1366" height="681"/><br/><br/></p>
                                    <p>Now fill in your registration <strong>User ID</strong> and
                                        <strong>Password</strong> and click on the <strong>Submit</strong> button; your
                                        student or guest ID will be open.<br/><br/><img
                                                src="../assets/article-media/03%20student%20or%20guest%20panel.png"
                                                alt="" width="1366" height="789"/><br/><br/></p>
                                    <p>The course list is available on your student or guest ID. Now, select the course
                                        that you want to rate and review, and simply click on the <strong>Course
                                            Detail</strong> tab, which is shown below in the course so that course
                                        detail model will be open. In this model, you can see <strong>Rate This</strong>
                                        option showing at the right side, click on <strong>Rate
                                            This </strong>option.<br/><br/><img
                                                src="../assets/article-media/04%20course%20details.png" alt=""
                                                width="1366" height="789"/><br/><br/><strong>Add Ratings</strong> model
                                        will be open.<br/><br/><img
                                                src="../assets/article-media/05%20add%20rating%20model.png" alt=""
                                                width="1366" height="674"/><br/><br/>You can rate the course by clicking
                                        on a <strong>Star</strong>, with one star ratings indicating low and five star
                                        ratings indicating highly appreciable, and you can also mention the course
                                        review then click on the <strong>save</strong> button, your record will be
                                        successfully saved.<br/><br/>If you want to see the rating that you recently
                                        gave that course, you need to come back to your Eduflow front
                                        page.<br/><br/><img
                                                src="../assets/article-media/06%20view%20rating%20in%20front%20page.png"
                                                alt="" width="1366" height="789"/><br/><br/></p>
                                    <p>When you click on a <strong>Course</strong> for which you have given ratings and
                                        reviews, the course detail page appears; simply scroll down to see the rating
                                        and review.&nbsp;<br/><br/><br/><img
                                                src="../assets/article-media/07%20view%20student%20feedback.png" alt=""
                                                width="1366" height="674"/><br/><br/><br/></p>
                                    <p>&nbsp;</p></article>
                            ...
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    ...
                                    <li><a href="how-to-check-online-course-reports.html">How to check online course
                                        reports?</a></li>
                                    <li><a href="how-to-manage-online-course-front-site-page.html">How to manage online
                                        course front site page?</a></li>
                                    ...
                                    <li><a href="how-to-generate-a-dynamic-guest-user-prefix-and-id.html">How to
                                        generate a dynamic guest user prefix and ID?</a></li>
                                    <li><a href="how-to-guest-user-signup-login-to-online-course.html">How to Guest user
                                        signup / login to online course?</a></li>
                                    <li><a href="how-to-add-course-category.php">How to add Course Category?</a></li>
                                </ul>
...
<!-- Mirrored from smart-school.in/article/how-student-guest-can-rate-and-review-course by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:38:59 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
