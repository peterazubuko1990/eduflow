...
<head><title>How student can check teacher review? - eduflow: School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Student can teacher review in Eduflow"/>
    <meta name="description" content="How student can teacher review?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How student can check teacher
                                    review?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    Resource</a></div>
                                <hr/>
                                <article class="article-body">After login student panel, go to side bar menu click on
                                    <strong>Teacher Review</strong>. Here you can see teacher&rsquo;s reviews and
                                    rate.<br/><br/><img
                                            src="../assets/article-media/humanresource-student-teacher%20reviews.png"
                                            alt="Student teacher reviews image " width="1340" height="648"/><br/><br/>To
                                    add teacher rate click on<strong> Add</strong> icon present in <strong>Rate</strong>
                                    column in teachers review page, at click of this icon <strong>Rate</strong> modal
                                    will be open. Here student can give <strong>Rating</strong> and
                                    <strong>Comment</strong> and then click on <strong>Save</strong> button.
                                    <br/><br/><img src="../assets/article-media/humanresource-student-rating.png"
                                                   alt="Student rating image" width="1366" height="618"/></article>
...
<!-- Mirrored from smart-school.in/article/how-student-can-check-teacher-review by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:40:41 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
