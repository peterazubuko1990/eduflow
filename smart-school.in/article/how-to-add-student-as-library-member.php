...
<head><title>How to add student as Library Member? - Eduflow : School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Eduflow add student as a library member"/>
    <meta name="description" content="How to Add student as Library Member?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add student as Library
                                    Member?</h3>
                                ...
                                <hr/>
                                <article class="article-body">To add student as Library Member, go to <strong>Library
                                    &gt; Add student</strong> then select the <strong>Class</strong> and
                                    <strong>Section</strong> and then click on the <strong>Search</strong> button to
                                    display student list. Now click on <strong>+</strong> icon from student's list,&nbsp;
                                    at click of this icon a modal will open, here enter <strong>Library Card
                                        Number</strong>&nbsp; and then click on the&nbsp;<strong> Add</strong>
                                    button.<br/><br/><img src="../assets/article-media/library-addstudent.png.png"
                                                          alt="Add student image" width="1000" height="455"/><br/><br/>The
                                    added student will be shown in green color row in the student list. To remove
                                    student's membership click on the <strong>Surrender</strong> button present in
                                    <strong>Action</strong> column.<br/><br/><img
                                            src="../assets/article-media/library-addstudent-member.png.png"
                                            alt="Add student image" width="1000" height="395"/></article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-student-as-library-member by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:32:43 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
