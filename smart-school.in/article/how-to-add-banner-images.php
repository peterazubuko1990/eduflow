...
<head><title>How to add Banner Images? - eduflow: School Management System by Eduflow</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="Add banner image in Eduflow"/>
    <meta name="description" content="How to add Banner Images?"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">How to add Banner Images?</h3>
                                ...
                                <div class='breadcrumb2'><a href="../index.php"><i class="fa fa-home"></i></a><a
                                    ...
                                    CMS</a></div>
                                <hr/>
                                <article class="article-body">To add banner image, go to <strong>Front CMS &gt; Banner
                                    Images</strong> then click on <strong>Add</strong> button present at top right
                                    corner in the <strong>Banner Images</strong> page, at click of this button <strong>Media
                                        Manager</strong> modal will be open, here select the file which you want to add
                                    in banner image ( you can search&nbsp; any file by its file type ( image, Video,
                                    Text, Zip, Pdf etc.) )&nbsp;then click on <strong>Add</strong> button.<br/><br/><img
                                            src="../assets/article-media/frontcms-add-bannerimage.png"
                                            alt="Add banner image " width="1349" height="650"/><br/><br/>Here you can
                                    see added record in the <strong>Banner Image</strong> page.<br/><br/><img
                                            src="../assets/article-media/frontcms-bannerimage.png" alt="banner image"
                                            width="1367" height="515"/><br/><br/>To delete banner image click on
                                    <strong>Delete</strong> icon present in the <strong>Banner Image</strong> page.
                                </article>
...
<!-- Mirrored from smart-school.in/article/how-to-add-banner-images by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:37:45 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
