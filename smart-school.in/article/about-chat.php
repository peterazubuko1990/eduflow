...
<head><title>About Chat - Smart School : School Management System by QDOCS</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Eduflow">
    <meta name="keywords" content="chat in smart school"/>
    <meta name="description" content="About Chat"/>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="file-right"><h3 class="info-title2">About Chat</h3>
                                ...
                                <hr/>
                                <article class="article-body">In Chat System, staff can chat with other staff members
                                    and student can also chat with other staff members. Before starting chat we have to
                                    add member to our chat list.<br/><br/><img
                                            src="../assets/article-media/chat-about.png" alt="About chat image"
                                            width="1366" height="633"/></article>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3">
                        <div class="ad_rsidebar">
                            <div class="sidebanners-ad"><a href="https://1.envato.market/smart_school_online_course"
                                                           target="_blank"><img
                                    src="../assets/front/ads/online-course.jpg" alt="Smart School"></a></div>
                        </div>
                        <div class="sidecard">
                        ...
                        <div class="sidecard">
                            <div class="content"><h4 class="info-title">Related Articles</h4>
                                <ul class="side-list">
                                    <li><a href="how-to-add-contact-in-chat.php">How to add contact in chat?</a></li>
                                </ul>
...
<!-- Mirrored from smart-school.in/article/about-chat by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:28:10 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
