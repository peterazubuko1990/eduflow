            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-9 col-lg-9 col-sm-12"><!-- //========================== -->
                        <div class="row">
                            <div class="col-md-12">
                                <div class="section-header spaceb20"><h1 class="head-title wow fadeInRight animated">
                                        Articles</h1>
                                    <div class='breadcrumb2'><a href="index.html"><i class="fa fa-home"></i></a><a
                                                href="#">Articles</a></div>
                                </div><!--./section-header--></div><!--./col-md-12--></div>
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <a href="category/installation.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 9 articles</a></div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                            href="category/system-update.html">System Update <span>(1)</span></a></h4>
                                <ul class="article-list">
                                    <li>
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <a href="category/common-issues-troubleshooting.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 14 articles</a></div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a href="category/faq.html">FAQ
                                ...
                                <a href="category/faq.html" class="see-more"> <i class="fa fa-angle-double-right"></i>
                                    See all 22 articles</a></div>
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <ul class="article-list">
                                    ...
                                    <li><a href="article/how-to-manage-attendance-type.html">How to manage attendance
                                            type?</a></li>
                                    <li><a href="article/how-to-manage-miscellaneous.html">How to manage
                                            miscellaneous?</a></li>
                                    <li><a href="article/how-to-manage-maintenance.html">How to manage maintenance?</a>
                                    </li>
                                </ul>
                                <a href="category/system-settings.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 30 articles</a></div>
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <a href="category/cbse-examination.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 22 articles</a></div>
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <ul class="article-list">
                                    ...
                                    <li><a href="article/how-to-fill-online-admission-form.html">How to fill online
                                            admission form?</a></li>
                                    <li><a href="article/how-to-review-online-admission-form-details.html">How to review
                                            online admission form details?</a></li>
                                    <li><a href="article/how-to-print-online-admission-form-receipt.html">How to print
                                            online admission form receipt?</a></li>
                                </ul>
                                <a href="category/online-admission.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 7 articles</a></div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <ul class="article-list">
                                    ...
                                    <li>
                                        <a href="article/how-to-check-student-yearly-session-attendance-in-his-profile-page-from-the-superadmin-side.html">How
                                            to check Student yearly (session) Attendance in his profile page from the
                                            superadmin side?</a></li>
                                    <li><a href="article/how-to-check-parent-login-credential-report.html">How to check
                                            Parent Login Credential Report?</a></li>
                                    <li><a href="article/how-to-assign-fees-during-student-enrolment.html">How to Assign
                                            Fees during Student Enrolment?</a></li>
                                    <li><a href="article/how-to-check-class-section-report.html">How to check class &
                                            section report?</a></li>
                                </ul>
                                <a href="category/student-information.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 26 articles</a></div>
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <a href="category/fees-collection.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 19 articles</a></div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <a href="category/examinations.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 17 articles</a></div>
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <a href="category/online-examinations.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 13 articles</a></div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <ul class="article-list">
                                    ...
                                    <li><a href="article/how-to-switch-the-branch.html">How to switch the branch?</a>
                                    </li>
                                </ul>
                                <a href="category/multi-branch.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 7 articles</a></div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <ul class="article-list">
                                    ...
                                    <li><a href="article/how-to-publishunpublish-course.html">How to publish/unpublish
                                            course?</a></li>
                                    <li><a href="article/how-to-check-online-course-from-student-panel.html">How to
                                            check online course from student panel?</a></li>
                                </ul>
                                <a href="category/online-course.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 18 articles</a></div>
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <ul class="article-list">
                                    ...
                                    <li><a href="article/how-to-setup-2fa.html">How to Setup 2FA?</a></li>
                                    <li>
                                        <a href="article/how-to-install-the-google-authenticator-app-on-a-mobile-device.html">How
                                            to Install the Google Authenticator app on a mobile device?</a></li>
                                    <li><a href="article/how-to-delete-the-2fa-account-for-superadmin-or-staff.html">How
                                            to delete the 2FA account for superadmin or staff?</a></li>
                                </ul>
                                <a href="category/two-factor-authentication.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 12 articles</a></div>
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                            href="category/zoom-live-classes.html">Zoom Live Classes
                                        <span>(13)</span></a></h4>
                                <ul class="article-list">
                                    ...
                                    <li><a href="article/how-to-enabledisable-teacher-api-credential.html">How to
                                            enable/disable teacher API credential?</a></li>
                                    <li><a href="article/how-to-enabled-disabled-the-parent-for-zoom-live-classes.html">How
                                            to enabled / disabled the parent for zoom live classes?</a></li>
                                </ul>
                                <a href="category/zoom-live-classes.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 13 articles</a></div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <ul class="article-list">
                                    ...
                                    <li><a href="article/how-to-create-gmeet-live-class.html">How to create Gmeet Live
                                            Class?</a></li>
                                    <li><a href="article/how-to-join-gmeet-live-class.html">How to join Gmeet Live
                                            Class?</a></li>
                                    <li><a href="article/how-to-check-gmeet-live-class-report.html">How to check Gmeet
                                            Live Class Report?</a></li>
                                </ul>
                                <a href="category/gmeet-live-class.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 11 articles</a></div>
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <a href="category/lesson-plan.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 8 articles</a></div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                            href="category/attendance.html">Attendance <span>(15)</span></a></h4>
                                <ul class="article-list">
                                    <li><a href="article/how-to-mark-student-attendance.html">How to mark student
                                            attendance?</a></li>
                                    <li><a href="article/how-to-check-student-attendance-by-date.html">How to check
                                            Student Attendance By Date?</a></li>
                                    <li><a href="article/how-to-check-student-attendance-report.html">How to check
                                            student Attendance Report?</a></li>
                                    <li><a href="article/how-to-check-student-attendance-type-report.html">How to check
                                            Student Attendance Type Report?</a></li>
                                    <li><a href="article/how-to-check-staff-attendance-report-1.html">How to check Staff
                                            Attendance report?</a></li>
                                </ul>
                                <a href="category/attendance.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 15 articles</a></div>
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <a href="category/certificate.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 9 articles</a></div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <a href="category/hostel.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 6 articles</a></div>
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <a href="category/transport.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 11 articles</a></div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <a href="category/library.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 11 articles</a></div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <ul class="article-list">
                                    ...
                                    <li><a href="article/how-to-check-homework-evaluation-report-2.html">How to check
                                            Homework Evaluation Report?</a></li>
                                </ul>
                                <a href="category/homework.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 6 articles</a></div>
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <ul class="article-list">
                                    ...
                                    <li><a href="article/how-to-send-sms.html">How to Send SMS?</a></li>
                                    <li><a href="article/how-to-view-email-sms-log.html">How to view Email / SMS
                                            Log?</a></li>
                                </ul>
                                <a href="category/communicate.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 10 articles</a></div>
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <a href="category/expenses.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 6 articles</a></div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <a href="category/income.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 6 articles</a></div>
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <a href="category/studentparent-panel.html" class="see-more"> <i
                                            class="fa fa-angle-double-right"></i> See all 23 articles</a></div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6"><h4 class="info-title"><a
                                ...
                                <ul class="subcategory-list">
                                    <li><a href="category/changelog/smart-school-two-factor-authentication.html">Smart
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-12"><!-- ad right sidebar -->
                    ...
                    <!--<div class="col-lg-12"><img src="assets/admin/assets/img/google-ads.jpg" class="img-responsive" style="width: 100%;"></div> -->
...
<!-- Mirrored from smart-school.in/articles by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 14:27:27 GMT -->
</html>
<script type="text/javascript">
    var currentFocus;
    $(document).ready(function () {
